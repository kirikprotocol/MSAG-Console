...
class BrowserIORequest extends WorkRequest
{
 ...
 private void listDirectory()
 {
  ...
  try
  {
   ...
   System.out.println("BrowserIORequest listDirectory() path1= "+path1+"  canonPath= "+canonPath);
   ...
   try
   {
    ...
    if(file != null)
    {
     ...
     else
     {
      ...
      System.out.println("BrowserIORequest rename line 267 path1= "+path1+" path2= "+path2);
