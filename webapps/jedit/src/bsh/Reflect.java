   ...
   try {
    ...
    Class clas = object.getClass();
       ...
       /* else  if ( object instanceof CallStack) {
          ...
          for (int i = 0; i < args.length; i++) {
          Object arg = args[i];
           System.out.println("arg= "+arg+" methodName= "+methodName+" depth= "+depth);
          if (arg instanceof NameSpace)  name=(NameSpace)arg;
          if (arg instanceof Primitive ) { prim=(Primitive)arg; if (prim.isNumber()) depth=prim.intValue(); }
          }
         System.out.println("Reflect invokeObjectMethod line 101 class= "+clas+" methodName= "+methodName+" depth= "+depth);
 ...
 */
  ...
  */
  ...
  if ( method == null && types.length > 0 ) 
  {
   ...
   Class c = clas;
      System.out.println("Reflect resolveJavaMethod line 485 class= "+clas);
   while( c != null )
   {
