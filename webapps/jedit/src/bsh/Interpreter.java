 ...
 void loadRCFiles() {
  try {
   String rcfile = 
    ...
    System.getProperty("user.home") + ""+jEdit.separatorChar + ".bshrc";
 ...
 */
  ...
  throws IOException
 {
  ...
  if ( !file.isAbsolute() ) {
   ...
   file = new File( cwd + ""+jEdit.separatorChar + fileName );
  }
 ...
 */
  try {
   systemLineSeparator = System.getProperty("line.separator");
       debug = System.err;
       DEBUG = false;//Boolean.getBoolean("debug");
      TRACE = false;// Boolean.getBoolean("trace");

      LOCALSCOPING = false; //Boolean.getBoolean("localscoping");
   String outfilename = null;//System.getProperty("outfile");
      if ( outfilename != null )
