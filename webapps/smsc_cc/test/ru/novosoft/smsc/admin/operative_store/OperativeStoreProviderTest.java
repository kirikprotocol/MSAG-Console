...
public class OperativeStoreProviderTest {
  ...
  private static final long[] ids = new long[]{
      ...
      3585951349L, 3468126014L, 3468562613L, 3585951198L, 3585951649L, 3585952070L, 3585939006L
  };
  ...
  private static final String[] oa = new String[]{
      ...
      ".0.1.4741", ".0.1.4741", ".0.1.4741", ".0.1.4741", ".5.0.MTC", ".5.0.MTC", ".0.1.4741"
  };
  ...
  private static final String[] da = new String[]{
      ...
      ".1.1.79158629879", ".1.1.79151115782", ".1.1.79167798724", ".1.1.79167515621", ".1.1.79196379352", ".1.1.79180700101", ".1.1.79150175226"
  };
  ...
  private static final String[] srcSmeId = new String[]{
      ...
      "tambmt", "mosmt", "mosmt", "mosmt", "InfoSme", "InfoSme", "mosmt"
  };
  ...
  private static final String[] dstSmeId = new String[]{
      ...
      "MAP_PROXY", "MAP_PROXY", "MAP_PROXY", "MAP_PROXY", "MAP_PROXY", "MAP_PROXY", "MAP_PROXY"
  };
  ...
  private static final String[] routeId = new String[]{
      ...
      "infosme > abonents", "infosme > abonents", "mosmt > subscribers"
  };
  ...
  public void beforeClass() throws IOException, AdminException {
    storeFile = TestUtils.exportResourceToRandomFile(OperativeStoreProviderTest.class.getResourceAsStream("store.bin"), ".operative_store");
  }
