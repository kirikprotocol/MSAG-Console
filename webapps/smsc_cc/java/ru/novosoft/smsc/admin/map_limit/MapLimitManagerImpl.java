 ...
 */
public class MapLimitManagerImpl implements MapLimitManager {
  ...
  public MapLimitManagerImpl(File configFile, File backupDir, ClusterController cc, FileSystem fs) throws AdminException {
    this.cc = cc;
