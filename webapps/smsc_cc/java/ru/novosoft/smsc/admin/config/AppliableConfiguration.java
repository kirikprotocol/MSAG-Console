...
public interface AppliableConfiguration {
  ...
  /**
   * Возвращает дату внесения последнего изменения в конфигурацию. Изменение
   * конфигурации - это вызов какого-то setter-а, или вызов метода reset().
   * Вызов apply() не влияет на значение, возвращаемое данным методом.
   * Метод возвращает -1, если в конфигурации не было изменений.
   * @return дату (в миллисекундах) последнего изменения конфига или -1, если изменений не было.
   */
