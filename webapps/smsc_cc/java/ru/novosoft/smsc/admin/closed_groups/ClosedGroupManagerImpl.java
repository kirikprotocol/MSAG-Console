 ...
 */
public class ClosedGroupManagerImpl implements ClosedGroupManager {
  ...
  public ClosedGroupManagerImpl(File configFile, File backupDir, ClusterController cc, FileSystem fs) throws AdminException {
  ...
  protected void load(InputStream is) throws AdminException {
    ...
    try {
      ...
      NodeList closedGroupsList = closedGroupDoc.getDocumentElement().getElementsByTagName(ClosedGroupManagerImpl.SECTION_NAME_group);
