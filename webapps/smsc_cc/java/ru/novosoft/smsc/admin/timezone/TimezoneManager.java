 ...
 */
public class TimezoneManager implements SmscConfiguration {

  private final ConfigFileManager<TimezoneSettings> cfgFileManager;
  private final ClusterController cc;

  public TimezoneManager(File configFile, File backupDir, FileSystem fileSystem, ClusterController cc) {
