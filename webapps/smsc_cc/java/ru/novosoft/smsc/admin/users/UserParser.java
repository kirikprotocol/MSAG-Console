...
public class UserParser {
  ...
  public static Collection<User> loadUsers(InputStream is) throws IOException, SAXException, ParserConfigurationException, AdminException {
  ...
  public static User parseUser(Element userElem) throws AdminException{
    User user = new User();
  ...
  public static UserPreferences parsePrefs(NodeList prefsList) throws AdminException{
  ...
  public static Collection<Element> formatUserPrefs(UserPreferences prefs, Document d) {
  ...
  public static Element formatUser(User u, Document d) {
  ...
  public static void saveUsers(OutputStream os, Collection<User> users) throws ParserConfigurationException, TransformerException {
