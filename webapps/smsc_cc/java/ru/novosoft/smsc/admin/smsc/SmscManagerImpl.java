...
public class SmscManagerImpl implements SmscManager {
  ...
  public SmscManagerImpl(ServiceManager serviceManager, ClusterController cc, FileSystem fileSystem) throws AdminException {
    this.cc = cc;
  ...
  SmscManagerImpl(File configFile, File backupDir, FileSystem fs, ClusterController cc, ServiceManager serviceManager) throws AdminException {
    this.cc = cc;
    this.serviceManager = serviceManager;
