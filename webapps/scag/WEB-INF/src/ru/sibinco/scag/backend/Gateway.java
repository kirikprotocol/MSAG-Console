...
public class Gateway extends Proxy {
    ...
    public Gateway(final String host, final int port, String serviceId) {
        super(host, port);
        id = serviceId;
    }
    ...
    public void deleteSme(final String smeId) throws SibincoException {         //ToDo delete this method
    ...
    public synchronized SmeStatus getSmeStatus(final String smeId) throws SibincoException {
        ...
        if (currentTime - Constants.ServicesRefreshTimeoutMillis > serviceRefreshTimeStamp) {
            ...
            smeStatuses.clear();
            String err = "Couldn't get sme status, nested: ";
            final Object result = call(SME_STATUS_ID, err, Type.Types[Type.STRING_LIST_TYPE], new HashMap());
