<link rel="STYLESHEET" type="text/css" href="content/styles/time.css">
<script src="content/scripts/time.js" type="text/javascript"></script>
<iframe id=timeIFrame class=timeHiddenLayer2 src="content/images/blank.html"></iframe>
