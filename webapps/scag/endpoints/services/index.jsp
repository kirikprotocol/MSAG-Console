...
<sm:page title="sp.index.title" onLoad="refreshStatus();disableDisconnect()">
  <jsp:attribute name="menu">
    <sm-pm:menu>
      ...
      <sm-pm:space/>
      <sm-pm:item name="mbDisconnect" value="status.item.mbdisconnect.value" title="status.item.mbdisconnect.title" isCheckSensible="false"/>
    </sm-pm:menu>
  </jsp:attribute>
  <jsp:body>
