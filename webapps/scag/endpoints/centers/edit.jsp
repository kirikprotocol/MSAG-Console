        ...
        <c:choose>
            <c:when test="${bean.transportId == 1}">
                ...
                <sm-ep:properties title="centers.edit.properties.smpp_info">
                    ...
                    <sm-ep:txt title="sp.edit.txt.inQueueLimit" name="inQueueLimit" maxlength="6" validation="unsigned"/>
                    <sm-ep:txt title="sp.edit.txt.maxSmsPerSec" name="maxSmsPerSec" maxlength="6" validation="unsigned"/>
                    <c:choose>
