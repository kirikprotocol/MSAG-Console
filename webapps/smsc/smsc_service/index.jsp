...
<%
  ...
  startSection(out, "core", "Core", false);
    startParams(out);
      ...
      param(out, "SMS max valid time",     "sms.max_valid_time",          bean.getIntParam("sms.max_valid_time"));
  ...
  startSection(out, "profiler", "Profiler", false);
    ...
    startSection(out, "profiler.ussdOpsMapping", "USSD operations mapping", false);
      startParams(out);
        ...
        param(out, "USSD 7 bit on",                             "profiler.ussdOpsMapping.USSD7BIT ON",         bean.getIntParam("profiler.ussdOpsMapping.USSD7BIT ON"));
        param(out, "USSD 7 bit off",                            "profiler.ussdOpsMapping.USSD7BIT OFF",        bean.getIntParam("profiler.ussdOpsMapping.USSD7BIT OFF"));
        ...
        param(out, "divert active absent on",                   "profiler.ussdOpsMapping.DIVERT ABSENT ON",    bean.getIntParam("profiler.ussdOpsMapping.DIVERT ABSENT ON"));
        param(out, "divert active absent off",                  "profiler.ussdOpsMapping.DIVERT ABSENT OFF",   bean.getIntParam("profiler.ussdOpsMapping.DIVERT ABSENT OFF"));
        param(out, "divert active blocked on",                  "profiler.ussdOpsMapping.DIVERT BLOCKED ON",   bean.getIntParam("profiler.ussdOpsMapping.DIVERT BLOCKED ON"));
        param(out, "divert active blocked off",                 "profiler.ussdOpsMapping.DIVERT BLOCKED OFF",  bean.getIntParam("profiler.ussdOpsMapping.DIVERT BLOCKED OFF"));
        param(out, "divert active barred on",                   "profiler.ussdOpsMapping.DIVERT BARRED ON",    bean.getIntParam("profiler.ussdOpsMapping.DIVERT BARRED ON"));
        param(out, "divert active barred off",                  "profiler.ussdOpsMapping.DIVERT BARRED OFF",   bean.getIntParam("profiler.ussdOpsMapping.DIVERT BARRED OFF"));
        param(out, "divert&nbsp;active&nbsp;capacity&nbsp;on",  "profiler.ussdOpsMapping.DIVERT CAPACITY ON",  bean.getIntParam("profiler.ussdOpsMapping.DIVERT CAPACITY ON"));
        param(out, "divert&nbsp;active&nbsp;capacity&nbsp;off", "profiler.ussdOpsMapping.DIVERT CAPACITY OFF", bean.getIntParam("profiler.ussdOpsMapping.DIVERT CAPACITY OFF"));
