...
<%
    ...
    startParams(out);
    param(out, "smsc.trControl.maxSmsPerSecond", "trafficControl.maxSmsPerSecond", bean.getIntParam(
            "trafficControl.maxSmsPerSecond"));
    param(out, "smsc.trControl.shapeTimeFrame", "trafficControl.shapeTimeFrame", bean.getIntParam(
            "trafficControl.shapeTimeFrame"));
    param(out, "smsc.trControl.startTimeFrame", "trafficControl.startTimeFrame", bean.getIntParam(
            "trafficControl.startTimeFrame"));
    param(out, "smsc.trControl.protectTimeFrame", "trafficControl.protectTimeFrame", bean.getIntParam(
            "trafficControl.protectTimeFrame"));
    param(out, "smsc.trControl.protectThreshold", "trafficControl.protectThreshold", bean.getIntParam(
            "trafficControl.protectThreshold"));
    param(out, "smsc.trControl.allowedDeliveryFailures", "trafficControl.allowedDeliveryFailures", bean.getIntParam(
            "trafficControl.allowedDeliveryFailures"));
    param(out, "smsc.trControl.lookAheadTime", "trafficControl.lookAheadTime", bean.getIntParam(
            "trafficControl.lookAheadTime"));
    finishParams(out);
    finishSection(out);
    //################################## MessageStore #############################
    ...
    param(out, "smsc.mesStor.billingInterval", "MessageStore.billingInterval", bean.getIntParam(
            "MessageStore.billingInterval"));
    param(out, "smsc.mesStor.archiveDir", "MessageStore.archiveDir", bean.getStringParam("MessageStore.archiveDir"));
    param(out, "smsc.mesStor.archiveInterval", "MessageStore.archiveInterval", bean.getIntParam(
            "MessageStore.archiveInterval"));
    ...
    startParams(out);
    param(out, "smsc.mesStor.localStore.filename", "MessageStore.LocalStore.filename", bean.getStringParam(
            "MessageStore.LocalStore.filename"));
    param(out, "smsc.mesStor.localStore.maxStoreSize", "MessageStore.LocalStore.maxStoreSize", bean.getIntParam(
            "MessageStore.LocalStore.maxStoreSize"));
    param(out, "smsc.mesStor.localStore.minRollTime", "MessageStore.LocalStore.minRollTime", bean.getIntParam(
            "MessageStore.LocalStore.minRollTime"));
    param(out, "smsc.mesStor.localStore.msgidfile", "MessageStore.LocalStore.msgidfile", bean.getStringParam(
            "MessageStore.LocalStore.msgidfile"));
    finishParams(out);
    finishSection(out);
    finishSection(out);
    //################################## smpp #############################
    ...
    param(out, "smsc.smpp.defaultConnectionsLimit", "smpp.defaultConnectionsLimit", bean.getIntParam(
            "smpp.defaultConnectionsLimit"));
    finishParams(out);
    ...
    paramSelect(out, "smsc.profiler.defaultDataCoding", "profiler.defaultDataCoding", profilerCodepages, bean.getStringParam(
            "profiler.defaultDataCoding"));
    paramSelect(out, "smsc.profiler.defaultReport", "profiler.defaultReport", profilerReportOptions, bean.getStringParam(
            "profiler.defaultReport"));
    param(out, "smsc.profiler.defaultHide", "profiler.defaultHide", bean.getBoolParam("profiler.defaultHide"));
    param(out, "smsc.profiler.defaultHideModifiable", "profiler.defaultHideModifiable", bean.getBoolParam(
            "profiler.defaultHideModifiable"));
    param(out, "smsc.profiler.defaultDivertModifiable", "profiler.defaultDivertModifiable", bean.getBoolParam(
            "profiler.defaultDivertModifiable"));
    param(out, "smsc.profiler.defaultUssdIn7Bit", "profiler.defaultUssdIn7Bit", bean.getBoolParam(
            "profiler.defaultUssdIn7Bit"));
    ...
    startParams(out);
    param(out, "smsc.profiler.ussdOpsMapping.reportNone", "profiler.ussdOpsMapping.REPORT NONE", bean.getIntParam(
            "profiler.ussdOpsMapping.REPORT NONE"));
    param(out, "smsc.profiler.ussdOpsMapping.reportFull", "profiler.ussdOpsMapping.REPORT FULL", bean.getIntParam(
            "profiler.ussdOpsMapping.REPORT FULL"));
    param(out, "smsc.profiler.ussdOpsMapping.reportFinal", "profiler.ussdOpsMapping.REPORT FINAL", bean.getIntParam(
            "profiler.ussdOpsMapping.REPORT FINAL"));
    param(out, "smsc.profiler.ussdOpsMapping.localeRuRu", "profiler.ussdOpsMapping.LOCALE RU_RU", bean.getIntParam(
            "profiler.ussdOpsMapping.LOCALE RU_RU"));
    param(out, "smsc.profiler.ussdOpsMapping.localeEnEn", "profiler.ussdOpsMapping.LOCALE EN_EN", bean.getIntParam(
            "profiler.ussdOpsMapping.LOCALE EN_EN"));
    param(out, "smsc.profiler.ussdOpsMapping.default", "profiler.ussdOpsMapping.DEFAULT", bean.getIntParam(
            "profiler.ussdOpsMapping.DEFAULT"));
    param(out, "smsc.profiler.ussdOpsMapping.ucs2", "profiler.ussdOpsMapping.UCS2", bean.getIntParam(
            "profiler.ussdOpsMapping.UCS2"));
    param(out, "smsc.profiler.ussdOpsMapping.hide", "profiler.ussdOpsMapping.HIDE", bean.getIntParam(
            "profiler.ussdOpsMapping.HIDE"));
    param(out, "smsc.profiler.ussdOpsMapping.unhide", "profiler.ussdOpsMapping.UNHIDE", bean.getIntParam(
            "profiler.ussdOpsMapping.UNHIDE"));
    param(out, "smsc.profiler.ussdOpsMapping.ussd7bitOn", "profiler.ussdOpsMapping.USSD7BIT ON", bean.getIntParam(
            "profiler.ussdOpsMapping.USSD7BIT ON"));
    param(out, "smsc.profiler.ussdOpsMapping.ussd7bitOff", "profiler.ussdOpsMapping.USSD7BIT OFF", bean.getIntParam(
            "profiler.ussdOpsMapping.USSD7BIT OFF"));
    param(out, "smsc.profiler.ussdOpsMapping.divertOn", "profiler.ussdOpsMapping.DIVERT ON", bean.getIntParam(
            "profiler.ussdOpsMapping.DIVERT ON"));
    param(out, "smsc.profiler.ussdOpsMapping.divertOff", "profiler.ussdOpsMapping.DIVERT OFF", bean.getIntParam(
            "profiler.ussdOpsMapping.DIVERT OFF"));
    param(out, "smsc.profiler.ussdOpsMapping.divertAbsentOn", "profiler.ussdOpsMapping.DIVERT ABSENT ON", bean.getIntParam(
            "profiler.ussdOpsMapping.DIVERT ABSENT ON"));
    param(out, "smsc.profiler.ussdOpsMapping.divertAbsentOff", "profiler.ussdOpsMapping.DIVERT ABSENT OFF", bean.getIntParam(
            "profiler.ussdOpsMapping.DIVERT ABSENT OFF"));
    param(out, "smsc.profiler.ussdOpsMapping.divertBlockedOn", "profiler.ussdOpsMapping.DIVERT BLOCKED ON", bean.getIntParam(
            "profiler.ussdOpsMapping.DIVERT BLOCKED ON"));
    param(out, "smsc.profiler.ussdOpsMapping.divertBlockedOff", "profiler.ussdOpsMapping.DIVERT BLOCKED OFF",
            bean.getIntParam("profiler.ussdOpsMapping.DIVERT BLOCKED OFF"));
    param(out, "smsc.profiler.ussdOpsMapping.divertBarredOn", "profiler.ussdOpsMapping.DIVERT BARRED ON", bean.getIntParam(
            "profiler.ussdOpsMapping.DIVERT BARRED ON"));
    param(out, "smsc.profiler.ussdOpsMapping.divertBarredOff", "profiler.ussdOpsMapping.DIVERT BARRED OFF", bean.getIntParam(
            "profiler.ussdOpsMapping.DIVERT BARRED OFF"));
    param(out, "smsc.profiler.ussdOpsMapping.divertCapacityOn", "profiler.ussdOpsMapping.DIVERT CAPACITY ON",
            bean.getIntParam("profiler.ussdOpsMapping.DIVERT CAPACITY ON"));
    param(out, "smsc.profiler.ussdOpsMapping.divertCapacityOff", "profiler.ussdOpsMapping.DIVERT CAPACITY OFF",
            bean.getIntParam("profiler.ussdOpsMapping.DIVERT CAPACITY OFF"));
    param(out, "smsc.profiler.ussdOpsMapping.divertStatus", "profiler.ussdOpsMapping.DIVERT STATUS", bean.getIntParam(
            "profiler.ussdOpsMapping.DIVERT STATUS"));
    param(out, "smsc.profiler.ussdOpsMapping.divertTo", "profiler.ussdOpsMapping.DIVERT TO", bean.getIntParam(
            "profiler.ussdOpsMapping.DIVERT TO"));
    param(out, "smsc.profiler.ussdOpsMapping.concatOn", "profiler.ussdOpsMapping.CONCAT ON", bean.getIntParam(
            "profiler.ussdOpsMapping.CONCAT ON"));
    param(out, "smsc.profiler.ussdOpsMapping.concatOff", "profiler.ussdOpsMapping.CONCAT OFF", bean.getIntParam(
            "profiler.ussdOpsMapping.CONCAT OFF"));
    param(out, "smsc.profiler.ussdOpsMapping.translitOn", "profiler.ussdOpsMapping.TRANSLIT ON", bean.getIntParam(
            "profiler.ussdOpsMapping.TRANSLIT ON"));
    param(out, "smsc.profiler.ussdOpsMapping.translitOff", "profiler.ussdOpsMapping.TRANSLIT OFF", bean.getIntParam(
            "profiler.ussdOpsMapping.TRANSLIT OFF"));
    finishParams(out);
    finishSection(out);
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~ profiler.notify ~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    param(out, "smsc.abonentInfo.mobileAccessAddr", "abonentinfo.mobile_access_address", bean.getStringParam(
            "abonentinfo.mobile_access_address"));
    param(out, "smsc.abonentInfo.smppAccessAddr", "abonentinfo.smpp_access_address", bean.getStringParam(
            "abonentinfo.smpp_access_address"));
    finishParams(out);
    finishSection(out);
    //################################## distrList #############################
    ...
    startParams(out);
    param(out, "smsc.MscManager.automaticRegistration", "MscManager.automaticRegistration", bean.getBoolParam(
            "MscManager.automaticRegistration"));
