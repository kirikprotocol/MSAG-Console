...
<%@ page import="ru.novosoft.smsc.admin.category.Category,
                 ru.novosoft.smsc.admin.provider.Provider,
                 ru.novosoft.smsc.admin.smsstat.ErrorCounterSet,
                 ru.novosoft.smsc.admin.smsstat.RouteIdCountersSet,
                 ru.novosoft.smsc.jsp.smsstat.RouteDetailBean,
...
//if (stat != null) {
    ...
    %>
        <tr class=row0>
            <td width="19%" align=right style="cursor:hand"
                onClick="toggleVisible(document.getElementById('p<%=disNo%>'), document.getElementById('c<%=disNo%>'));">
                <div id="p<%=disNo%>" class=collapsing_list_closed><%= routeStr%></div></td>
