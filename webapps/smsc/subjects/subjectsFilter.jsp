...
<div class=content>
    ...
    <table class=properties_list cellspacing=0 cellspadding=0>
        ...
        %>
        <tr class=row<%=(rowN++) & 1%>>
            <td><input class=check id="subj_sme_<%=encName%>" type=checkbox name=checkedSmes
                       value="<%=encName%>" <%=bean.isSmeChecked(name) ? "checked" : ""%>></td>
    ...
    <table class=properties_list cellspacing=0 cellspadding=0>
        ...
        %>
        <tr class=row<%=(rowN++) & 1%>>
            <td><input class=check id="subj_chk_<%=encName%>" type=checkbox name=checkedSubjects
                       value="<%=encName%>" <%=bean.isSubjChecked(name) ? "checked" : ""%>></td>
