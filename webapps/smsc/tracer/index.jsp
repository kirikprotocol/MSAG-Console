...
<div class=content>
    ...
    <table class=properties_list cell><%
        ...
        <tr class=row<%=rowN++ & 1%>>
            <th width="30%"
                nowrap><%=(key != null && key.trim().length() > 0) ? StringEncoderDecoder.encode(key) : "&nbsp;"%></th>
            <td width="70%"
                nowrap><%=(val != null && val.trim().length() > 0) ? StringEncoderDecoder.encode(val) : "&nbsp;"%></td>
        </tr><%
        }%>
    </table>
    <%}%>
