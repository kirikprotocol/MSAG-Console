...
<%@ page import="ru.novosoft.smsc.admin.profiler.Profile,
                 ...
                 ru.novosoft.smsc.jsp.smsc.profiles.Lookup" %>
...
<div class=content>
    <%=getLocString("profiles.abonentNumber")%>&nbsp;<input class=txt name=profile
                                                            value="<%=bean.getProfile() != null ? bean.getProfile() : ""%>"
...
%>
    <br><%=getLocString("profiles.aliasedPre") + bean.getMatchAddress().getMask() + getLocString("profiles.aliasedPost") + bean.getProfileAliased() + "\""%>
    <br><%
    }
%>
</div>
