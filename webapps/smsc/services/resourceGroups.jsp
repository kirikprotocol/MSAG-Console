...
<tr class=row<%=row&1%>>
	...
	<%if (request.isUserInRole("services")) {%><td class=name><a  href="#" title="<%=getLocString("services.editSubTitle")%>" onClick="return editService('<%=encodedServiceId%>');"><%=getLocString("common.links.edit")%></a></td><%}%>	<td class=name><%
