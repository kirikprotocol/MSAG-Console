...
<div class=content>
    ...
    <table class=list>
            ...
            if (bean.getReshedules() != null) {
                for (Iterator i = bean.getReshedules().iterator(); i.hasNext();) {
                    ...
                    if (rows == 0)
                        rows = 1;
        %><tr class=row0>
        <td><input class=check type=checkbox name=checkedShedules
                   value="<%=reshedule%>" <%=bean.isSheduleChecked(reshedule) ? "checked" : ""%>></td>
        ...
        %><tr class=row1>
        <td colspan=2>
            <table style="border:none"><col width=80px><%
            ...
            %><tr style="border:none">
                <td style="border:none" align=right>(<%=errorCode%>)</td><td
                    style="border:none"><%=errorCodeString != null ? errorCodeString : ""%></td></tr><%
                }
            %></table>
        </td></tr><%
                }
