...
<meta http-equiv="refresh" content="0;url=<%=urlPrefix+servicesPrefix+"/shutdown_service_wait.jsp?host="+URLEncoder.encode(host)+"&service="+URLEncoder.encode(service)%>">
