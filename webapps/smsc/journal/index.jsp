...
<%@ page import="ru.novosoft.smsc.admin.journal.Action,
                 ...
                 ru.novosoft.smsc.jsp.journal.Index,
...
<div class=content>
    ...
    <table class=list cellspacing=0>
        ...
        <thead>
            <tr>
                <th>
                    <a href="javascript:setSort('timestamp')" <%=bean.getSort().endsWith("timestamp") ? (bean.getSort().charAt(0) == '-' ? "class=up" : "class=down") : ""%>
                       title="<%=getLocString("common.sortmodes.timeHint")%>"><%=getLocString("common.sortmodes.time")%></a>
                </th>
                <th>
                ...
                <th>
                    <a href="javascript:setSort('subjectId')" <%=bean.getSort().endsWith("subjectId") ? (bean.getSort().charAt(0) == '-' ? "class=up" : "class=down") : ""%>
                       title="<%=getLocString("common.sortmodes.subjectIdHint")%>"><%=getLocString("common.sortmodes.subjectId")%></a>
                </th>
                <th>
                    <a href="javascript:setSort('action')" <%=bean.getSort().endsWith("action") ? (bean.getSort().charAt(0) == '-' ? "class=up" : "class=down") : ""%>
                       title="<%=getLocString("common.sortmodes.actionHint")%>"><%=getLocString("common.sortmodes.action")%></a>
                </th>
