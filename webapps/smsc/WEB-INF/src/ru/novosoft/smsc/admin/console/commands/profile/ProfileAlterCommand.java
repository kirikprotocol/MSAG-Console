...
public class ProfileAlterCommand extends ProfileGenCommand {
  static Category logger = Category.getInstance(ProfileAlterCommand.class);
  ...
  public void process(CommandContext ctx) {
    ...
    try {
      ...
      if (profile == null) {
        ...
        if (isDivertActiveUnconditional)
          profile.setDivertActiveUnconditional(divertActiveOn && divertActiveUnconditional);
      ...
      logger.error("Couldn't alter profile", e);
