...
public class Mask
{
  ...
  private static final String special_pattern1 = special_pattern_header + "[ _\\-:\\.\\,0-9A-Za-z]{0,20}\\?{0,10}$";
  private static final String special_pattern2 = special_pattern_header + "([ _\\-:\\.\\,0-9A-Za-z]|\\?){1,10}$";
