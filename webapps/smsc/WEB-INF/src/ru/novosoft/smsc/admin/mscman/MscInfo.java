...
public class MscInfo {
  ...
  public MscInfo(String str) throws IllegalArgumentException
  {
    try {
      ...
      if (str.startsWith(","))
        ...
        mscNum = st.nextToken();
      if (mscNum == null || mscNum.length() <= 0) mscNum = "";
      ...
      exc.printStackTrace();
      throw new IllegalArgumentException("MscInfo init string misformatted, nested:" + exc.getMessage());
    }
  }
