...
public CommandLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("off", this), new Integer(60));
	literals.put(new ANTLRHashString("numelem", this), new Integer(39));
	literals.put(new ANTLRHashString("capacity", this), new Integer(47));
	literals.put(new ANTLRHashString("active", this), new Integer(42));
	literals.put(new ANTLRHashString("ucs2-latin1", this), new Integer(69));
	literals.put(new ANTLRHashString("absent", this), new Integer(44));
	literals.put(new ANTLRHashString("locale", this), new Integer(41));
	literals.put(new ANTLRHashString("srcsme", this), new Integer(54));
	literals.put(new ANTLRHashString("arc", this), new Integer(23));
	literals.put(new ANTLRHashString("forceReplayPath", this), new Integer(62));
	...
	literals.put(new ANTLRHashString("blocked", this), new Integer(46));
	literals.put(new ANTLRHashString("owner", this), new Integer(40));
	literals.put(new ANTLRHashString("subject", this), new Integer(14));
	literals.put(new ANTLRHashString("set", this), new Integer(55));
	literals.put(new ANTLRHashString("clear", this), new Integer(56));
	literals.put(new ANTLRHashString("modifiable", this), new Integer(49));
	literals.put(new ANTLRHashString("notmodifiable", this), new Integer(50));
	literals.put(new ANTLRHashString("dm", this), new Integer(52));
	literals.put(new ANTLRHashString("none", this), new Integer(65));
	literals.put(new ANTLRHashString("ucs2", this), new Integer(67));
	literals.put(new ANTLRHashString("full", this), new Integer(64));
	literals.put(new ANTLRHashString("profile", this), new Integer(13));
	literals.put(new ANTLRHashString("deny", this), new Integer(26));
	literals.put(new ANTLRHashString("notes", this), new Integer(61));
	...
	literals.put(new ANTLRHashString("default", this), new Integer(66));
	literals.put(new ANTLRHashString("alias", this), new Integer(11));
	literals.put(new ANTLRHashString("fwd", this), new Integer(53));
	literals.put(new ANTLRHashString("mask", this), new Integer(31));
	literals.put(new ANTLRHashString("latin1", this), new Integer(68));
	literals.put(new ANTLRHashString("dlmember", this), new Integer(18));
	literals.put(new ANTLRHashString("forceDelivery", this), new Integer(63));
	literals.put(new ANTLRHashString("on", this), new Integer(59));
	literals.put(new ANTLRHashString("encoding", this), new Integer(37));
	literals.put(new ANTLRHashString("forward", this), new Integer(71));
	literals.put(new ANTLRHashString("numlist", this), new Integer(38));
	literals.put(new ANTLRHashString("datagram", this), new Integer(72));
	literals.put(new ANTLRHashString("store", this), new Integer(70));
	literals.put(new ANTLRHashString("allow", this), new Integer(25));
	literals.put(new ANTLRHashString("principal", this), new Integer(15));
	literals.put(new ANTLRHashString("barred", this), new Integer(45));
	literals.put(new ANTLRHashString("unconditional", this), new Integer(48));
