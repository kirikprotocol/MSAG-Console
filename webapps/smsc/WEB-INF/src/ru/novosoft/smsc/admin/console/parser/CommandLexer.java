...
public CommandLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("full", this), new Integer(50));
	...
	literals.put(new ANTLRHashString("datagram", this), new Integer(56));
	...
	literals.put(new ANTLRHashString("none", this), new Integer(51));
	...
	literals.put(new ANTLRHashString("forward", this), new Integer(55));
	...
	literals.put(new ANTLRHashString("store", this), new Integer(54));
	...
	literals.put(new ANTLRHashString("ucs2", this), new Integer(52));
