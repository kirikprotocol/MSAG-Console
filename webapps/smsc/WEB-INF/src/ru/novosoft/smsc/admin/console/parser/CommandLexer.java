...
public CommandLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("full", this), new Integer(150));
	literals.put(new ANTLRHashString("barred", this), new Integer(78));
	literals.put(new ANTLRHashString("translit", this), new Integer(93));
	literals.put(new ANTLRHashString("route", this), new Integer(24));
	literals.put(new ANTLRHashString("udhconcat", this), new Integer(92));
	literals.put(new ANTLRHashString("ucs2-latin1", this), new Integer(156));
	...
	literals.put(new ANTLRHashString("RX", this), new Integer(161));
	literals.put(new ANTLRHashString("pass", this), new Integer(149));
	literals.put(new ANTLRHashString("store", this), new Integer(157));
	literals.put(new ANTLRHashString("divert", this), new Integer(84));
	literals.put(new ANTLRHashString("aliases", this), new Integer(23));
	literals.put(new ANTLRHashString("outputaccessbit", this), new Integer(122));
	literals.put(new ANTLRHashString("clear", this), new Integer(90));
	literals.put(new ANTLRHashString("import", this), new Integer(45));
	literals.put(new ANTLRHashString("forceDelivery", this), new Integer(98));
	literals.put(new ANTLRHashString("grant", this), new Integer(11));
	literals.put(new ANTLRHashString("timeout", this), new Integer(109));
	literals.put(new ANTLRHashString("task", this), new Integer(135));
	literals.put(new ANTLRHashString("transit", this), new Integer(116));
	...
	literals.put(new ANTLRHashString("descr", this), new Integer(118));
	literals.put(new ANTLRHashString("SMPP", this), new Integer(163));
	literals.put(new ANTLRHashString("emailsme", this), new Integer(44));
	literals.put(new ANTLRHashString("servicesmask", this), new Integer(131));
	literals.put(new ANTLRHashString("arc", this), new Integer(56));
	literals.put(new ANTLRHashString("disabled", this), new Integer(115));
	literals.put(new ANTLRHashString("absent", this), new Integer(77));
	literals.put(new ANTLRHashString("replayPath", this), new Integer(97));
	...
	literals.put(new ANTLRHashString("proclimit", this), new Integer(111));
	literals.put(new ANTLRHashString("hide", this), new Integer(49));
	literals.put(new ANTLRHashString("inputaccessbit", this), new Integer(120));
	literals.put(new ANTLRHashString("none", this), new Integer(152));
	literals.put(new ANTLRHashString("outputaccessmask", this), new Integer(121));
	literals.put(new ANTLRHashString("noreceipt", this), new Integer(61));
	literals.put(new ANTLRHashString("inputaccessmask", this), new Integer(119));
	literals.put(new ANTLRHashString("cache", this), new Integer(99));
	literals.put(new ANTLRHashString("suppress", this), new Integer(148));
	...
	literals.put(new ANTLRHashString("forceDC", this), new Integer(114));
	literals.put(new ANTLRHashString("off", this), new Integer(95));
	literals.put(new ANTLRHashString("dlmember", this), new Integer(31));
	literals.put(new ANTLRHashString("forward", this), new Integer(158));
	literals.put(new ANTLRHashString("all", this), new Integer(21));
	literals.put(new ANTLRHashString("wantAlias", this), new Integer(113));
	literals.put(new ANTLRHashString("bill", this), new Integer(52));
	literals.put(new ANTLRHashString("status", this), new Integer(137));
	literals.put(new ANTLRHashString("limitvalue", this), new Integer(130));
	literals.put(new ANTLRHashString("latin1", this), new Integer(155));
	literals.put(new ANTLRHashString("addressRange", this), new Integer(103));
	literals.put(new ANTLRHashString("defaultsme", this), new Integer(68));
	literals.put(new ANTLRHashString("username", this), new Integer(125));
	literals.put(new ANTLRHashString("forcereceipt", this), new Integer(144));
	...
	literals.put(new ANTLRHashString("limittype", this), new Integer(129));
	literals.put(new ANTLRHashString("accessmask", this), new Integer(123));
	literals.put(new ANTLRHashString("category", this), new Integer(36));
	literals.put(new ANTLRHashString("npi", this), new Integer(105));
	literals.put(new ANTLRHashString("connect", this), new Integer(16));
	literals.put(new ANTLRHashString("ton", this), new Integer(104));
	literals.put(new ANTLRHashString("to", this), new Integer(20));
	literals.put(new ANTLRHashString("realname", this), new Integer(127));
	...
	literals.put(new ANTLRHashString("force", this), new Integer(147));
	literals.put(new ANTLRHashString("final", this), new Integer(151));
	literals.put(new ANTLRHashString("export", this), new Integer(14));
	literals.put(new ANTLRHashString("TX", this), new Integer(160));
	literals.put(new ANTLRHashString("deny", this), new Integer(59));
	literals.put(new ANTLRHashString("schedlimit", this), new Integer(112));
	literals.put(new ANTLRHashString("messages", this), new Integer(41));
	literals.put(new ANTLRHashString("rename", this), new Integer(117));
	literals.put(new ANTLRHashString("subject", this), new Integer(27));
	literals.put(new ANTLRHashString("list", this), new Integer(7));
	literals.put(new ANTLRHashString("SS7", this), new Integer(164));
	literals.put(new ANTLRHashString("ussd7bit", this), new Integer(91));
	literals.put(new ANTLRHashString("serviceid", this), new Integer(66));
	literals.put(new ANTLRHashString("remove", this), new Integer(139));
	...
	literals.put(new ANTLRHashString("resend", this), new Integer(138));
	literals.put(new ANTLRHashString("notes", this), new Integer(96));
	literals.put(new ANTLRHashString("set", this), new Integer(89));
	literals.put(new ANTLRHashString("dm", this), new Integer(85));
	literals.put(new ANTLRHashString("TRX", this), new Integer(162));
	literals.put(new ANTLRHashString("ucs2", this), new Integer(154));
	literals.put(new ANTLRHashString("sms", this), new Integer(40));
	literals.put(new ANTLRHashString("interfaceVersion", this), new Integer(106));
	...
	literals.put(new ANTLRHashString("carryorguser", this), new Integer(141));
	literals.put(new ANTLRHashString("subj", this), new Integer(65));
	literals.put(new ANTLRHashString("group", this), new Integer(43));
	literals.put(new ANTLRHashString("carryorgdesc", this), new Integer(140));
	literals.put(new ANTLRHashString("dst", this), new Integer(63));
	literals.put(new ANTLRHashString("default", this), new Integer(153));
	literals.put(new ANTLRHashString("numelem", this), new Integer(72));
	literals.put(new ANTLRHashString("smppplus", this), new Integer(145));
	literals.put(new ANTLRHashString("accessbit", this), new Integer(124));
	literals.put(new ANTLRHashString("allow", this), new Integer(58));
	literals.put(new ANTLRHashString("alter", this), new Integer(5));
	literals.put(new ANTLRHashString("password", this), new Integer(108));
	literals.put(new ANTLRHashString("revoke", this), new Integer(12));
	literals.put(new ANTLRHashString("id", this), new Integer(47));
	literals.put(new ANTLRHashString("datagram", this), new Integer(159));
	literals.put(new ANTLRHashString("servicesbit", this), new Integer(132));
	...
	literals.put(new ANTLRHashString("carrysccp", this), new Integer(142));
	...
	literals.put(new ANTLRHashString("smeN", this), new Integer(102));
	literals.put(new ANTLRHashString("disconnect", this), new Integer(17));
	literals.put(new ANTLRHashString("show", this), new Integer(10));
	literals.put(new ANTLRHashString("fillextra", this), new Integer(143));
	literals.put(new ANTLRHashString("on", this), new Integer(94));
	literals.put(new ANTLRHashString("create", this), new Integer(136));
	literals.put(new ANTLRHashString("categories", this), new Integer(37));
	literals.put(new ANTLRHashString("systemType", this), new Integer(107));
	literals.put(new ANTLRHashString("receiptScheme", this), new Integer(110));
	literals.put(new ANTLRHashString("nick", this), new Integer(134));
	literals.put(new ANTLRHashString("forwardemail", this), new Integer(126));
	literals.put(new ANTLRHashString("backupsme", this), new Integer(87));
	literals.put(new ANTLRHashString("mode", this), new Integer(100));
	literals.put(new ANTLRHashString("infosme", this), new Integer(15));
	literals.put(new ANTLRHashString("address", this), new Integer(128));
	literals.put(new ANTLRHashString("substitute", this), new Integer(51));
	literals.put(new ANTLRHashString("sponsored", this), new Integer(133));
	literals.put(new ANTLRHashString("capacity", this), new Integer(80));
	literals.put(new ANTLRHashString("defaultDcLatin1", this), new Integer(146));
	literals.put(new ANTLRHashString("mtbill", this), new Integer(54));
	literals.put(new ANTLRHashString("type", this), new Integer(101));
	literals.put(new ANTLRHashString("srcsme", this), new Integer(88));
