...
public CommandLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("latin1", this), new Integer(65));
	literals.put(new ANTLRHashString("dl", this), new Integer(16));
	literals.put(new ANTLRHashString("full", this), new Integer(61));
	...
	literals.put(new ANTLRHashString("datagram", this), new Integer(69));
	...
	literals.put(new ANTLRHashString("none", this), new Integer(62));
	literals.put(new ANTLRHashString("srcsme", this), new Integer(54));
	literals.put(new ANTLRHashString("bill", this), new Integer(21));
	literals.put(new ANTLRHashString("ucs2-latin1", this), new Integer(66));
	...
	literals.put(new ANTLRHashString("forward", this), new Integer(68));
	...
	literals.put(new ANTLRHashString("store", this), new Integer(67));
	...
	literals.put(new ANTLRHashString("default", this), new Integer(63));
	literals.put(new ANTLRHashString("clear", this), new Integer(56));
	literals.put(new ANTLRHashString("ucs2", this), new Integer(64));
