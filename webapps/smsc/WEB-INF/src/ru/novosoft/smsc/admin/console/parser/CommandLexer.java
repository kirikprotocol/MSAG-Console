...
public CommandLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("pass", this), new Integer(118));
	...
	literals.put(new ANTLRHashString("TX", this), new Integer(129));
	...
	literals.put(new ANTLRHashString("RX", this), new Integer(130));
	literals.put(new ANTLRHashString("transit", this), new Integer(107));
	...
	literals.put(new ANTLRHashString("full", this), new Integer(119));
	...
	literals.put(new ANTLRHashString("SMPP", this), new Integer(132));
	literals.put(new ANTLRHashString("latin1", this), new Integer(124));
	...
	literals.put(new ANTLRHashString("forward", this), new Integer(127));
	literals.put(new ANTLRHashString("numlist", this), new Integer(63));
	literals.put(new ANTLRHashString("rename", this), new Integer(108));
	literals.put(new ANTLRHashString("datagram", this), new Integer(128));
	literals.put(new ANTLRHashString("store", this), new Integer(126));
	...
	literals.put(new ANTLRHashString("group", this), new Integer(41));
