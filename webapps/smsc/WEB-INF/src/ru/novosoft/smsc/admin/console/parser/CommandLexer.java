...
public CommandLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("latin1", this), new Integer(57));
	literals.put(new ANTLRHashString("dl", this), new Integer(16));
	literals.put(new ANTLRHashString("full", this), new Integer(53));
	...
	literals.put(new ANTLRHashString("datagram", this), new Integer(61));
	...
	literals.put(new ANTLRHashString("ussd7bit", this), new Integer(52));
	literals.put(new ANTLRHashString("none", this), new Integer(54));
	literals.put(new ANTLRHashString("srcsme", this), new Integer(49));
	literals.put(new ANTLRHashString("bill", this), new Integer(21));
	literals.put(new ANTLRHashString("ucs2-latin1", this), new Integer(58));
	...
	literals.put(new ANTLRHashString("forward", this), new Integer(60));
	...
	literals.put(new ANTLRHashString("store", this), new Integer(59));
	...
	literals.put(new ANTLRHashString("ucs2", this), new Integer(56));
