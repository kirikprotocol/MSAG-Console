...
public CommandLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("full", this), new Integer(140));
	...
	literals.put(new ANTLRHashString("ucs2-latin1", this), new Integer(146));
	...
	literals.put(new ANTLRHashString("RX", this), new Integer(151));
	literals.put(new ANTLRHashString("pass", this), new Integer(139));
	literals.put(new ANTLRHashString("store", this), new Integer(147));
	...
	literals.put(new ANTLRHashString("SMPP", this), new Integer(153));
	...
	literals.put(new ANTLRHashString("none", this), new Integer(142));
	...
	literals.put(new ANTLRHashString("suppress", this), new Integer(138));
	...
	literals.put(new ANTLRHashString("forward", this), new Integer(148));
	...
	literals.put(new ANTLRHashString("latin1", this), new Integer(145));
	...
	literals.put(new ANTLRHashString("force", this), new Integer(137));
	literals.put(new ANTLRHashString("final", this), new Integer(141));
	literals.put(new ANTLRHashString("export", this), new Integer(14));
	literals.put(new ANTLRHashString("TX", this), new Integer(150));
	...
	literals.put(new ANTLRHashString("SS7", this), new Integer(154));
	...
	literals.put(new ANTLRHashString("TRX", this), new Integer(152));
	literals.put(new ANTLRHashString("ucs2", this), new Integer(144));
	...
	literals.put(new ANTLRHashString("default", this), new Integer(143));
	...
	literals.put(new ANTLRHashString("datagram", this), new Integer(149));
