...
public CommandLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("latin1", this), new Integer(64));
	...
	literals.put(new ANTLRHashString("datagram", this), new Integer(68));
	...
	literals.put(new ANTLRHashString("on", this), new Integer(58));
	...
	literals.put(new ANTLRHashString("ucs2-latin1", this), new Integer(65));
	literals.put(new ANTLRHashString("allow", this), new Integer(25));
	literals.put(new ANTLRHashString("off", this), new Integer(59));
	...
	literals.put(new ANTLRHashString("forward", this), new Integer(67));
	...
	literals.put(new ANTLRHashString("store", this), new Integer(66));
	...
	literals.put(new ANTLRHashString("ucs2", this), new Integer(63));
