...
public CommandLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("type", this), new Integer(92));
	literals.put(new ANTLRHashString("priority", this), new Integer(59));
	literals.put(new ANTLRHashString("noreceipt", this), new Integer(53));
	literals.put(new ANTLRHashString("name", this), new Integer(42));
	literals.put(new ANTLRHashString("hide", this), new Integer(43));
	...
	literals.put(new ANTLRHashString("ussd7bit", this), new Integer(82));
	literals.put(new ANTLRHashString("schedlimit", this), new Integer(103));
	literals.put(new ANTLRHashString("bill", this), new Integer(46));
	literals.put(new ANTLRHashString("delete", this), new Integer(6));
	literals.put(new ANTLRHashString("divert", this), new Integer(76));
	literals.put(new ANTLRHashString("view", this), new Integer(8));
	literals.put(new ANTLRHashString("disabled", this), new Integer(106));
	literals.put(new ANTLRHashString("check", this), new Integer(13));
	literals.put(new ANTLRHashString("subj", this), new Integer(57));
	literals.put(new ANTLRHashString("smeN", this), new Integer(93));
	...
	literals.put(new ANTLRHashString("replayPath", this), new Integer(88));
	literals.put(new ANTLRHashString("numelem", this), new Integer(64));
	literals.put(new ANTLRHashString("timeout", this), new Integer(100));
	literals.put(new ANTLRHashString("capacity", this), new Integer(72));
	literals.put(new ANTLRHashString("active", this), new Integer(67));
	...
	literals.put(new ANTLRHashString("substitute", this), new Integer(45));
	literals.put(new ANTLRHashString("pass", this), new Integer(109));
	literals.put(new ANTLRHashString("arc", this), new Integer(48));
	literals.put(new ANTLRHashString("category", this), new Integer(36));
	literals.put(new ANTLRHashString("add", this), new Integer(4));
	literals.put(new ANTLRHashString("defaultsme", this), new Integer(60));
	literals.put(new ANTLRHashString("receipt", this), new Integer(52));
	literals.put(new ANTLRHashString("route", this), new Integer(23));
	literals.put(new ANTLRHashString("password", this), new Integer(99));
	literals.put(new ANTLRHashString("blocked", this), new Integer(71));
	literals.put(new ANTLRHashString("owner", this), new Integer(65));
	...
	literals.put(new ANTLRHashString("nohide", this), new Integer(44));
	...
	literals.put(new ANTLRHashString("nobill", this), new Integer(47));
	...
	literals.put(new ANTLRHashString("fwd", this), new Integer(78));
	literals.put(new ANTLRHashString("wantAlias", this), new Integer(104));
	literals.put(new ANTLRHashString("mask", this), new Integer(56));
	literals.put(new ANTLRHashString("SMPP", this), new Integer(122));
	literals.put(new ANTLRHashString("latin1", this), new Integer(114));
	literals.put(new ANTLRHashString("systemType", this), new Integer(98));
	literals.put(new ANTLRHashString("dlmember", this), new Integer(31));
	literals.put(new ANTLRHashString("forceDelivery", this), new Integer(89));
	literals.put(new ANTLRHashString("on", this), new Integer(85));
	literals.put(new ANTLRHashString("export", this), new Integer(14));
	literals.put(new ANTLRHashString("encoding", this), new Integer(62));
	literals.put(new ANTLRHashString("forward", this), new Integer(117));
	literals.put(new ANTLRHashString("numlist", this), new Integer(63));
	literals.put(new ANTLRHashString("datagram", this), new Integer(118));
	literals.put(new ANTLRHashString("profiles", this), new Integer(26));
	...
	literals.put(new ANTLRHashString("barred", this), new Integer(70));
	literals.put(new ANTLRHashString("unconditional", this), new Integer(73));
	literals.put(new ANTLRHashString("proclimit", this), new Integer(102));
	literals.put(new ANTLRHashString("serviceid", this), new Integer(58));
