...
public interface CommandParserTokenTypes {
	...
	int OPT_NPI = 104;
	int OPT_INT_V = 105;
	int OPT_SYS_TYPE = 106;
	int OPT_PASSWORD = 107;
	int OPT_TIMEOUT = 108;
	int OPT_R_SCHEME = 109;
	int OPT_P_LIMIT = 110;
	int OPT_S_LIMIT = 111;
	int OPT_WANT_ALIAS = 112;
	int OPT_FORCE_DC = 113;
	int OPT_DISABLED = 114;
	int OPT_TRANSIT = 115;
	int OPT_RENAME = 116;
	int OPT_DESCR = 117;
	int OPT_INPUTACCESSMASK = 118;
	int OPT_INPUTACCESSBIT = 119;
	int OPT_OUTPUTACCESSMASK = 120;
	int OPT_OUTPUTACCESSBIT = 121;
	int OPT_ACCESSMASK = 122;
	int OPT_ACCESSBIT = 123;
	int OPT_USERNAME = 124;
	int OPT_FORWARDEMAIL = 125;
	int OPT_REALNAME = 126;
	int OPT_ADDRESS = 127;
	int OPT_LIMITTYPE = 128;
	int OPT_LIMITVALUE = 129;
	int OPT_SERVICESMASK = 130;
	int OPT_SERVICESBIT = 131;
	int OPT_SPONSORED = 132;
	int OPT_NICK = 133;
	int OPT_TASK = 134;
	int OPT_CREATE = 135;
	int OPT_STATUS = 136;
	int OPT_RESEND = 137;
	int OPT_REMOVE = 138;
	int OPT_CARRY_ORG_DESCRIPTOR = 139;
	int OPT_CARRY_ORG_USER_INFO = 140;
	int OPT_CARRY_SCCP_INFO = 141;
	int OPT_FILL_EXTRA_DESCRIPTOR = 142;
	int OPT_FORCE_SME_RECEIPT = 143;
	int OPT_SMPP_PLUS = 144;
	int VAL_FORCE = 145;
	int VAL_SUPPRESS = 146;
	int VAL_PASS = 147;
	int VAL_FULL = 148;
	int VAL_FINAL = 149;
	int VAL_NONE = 150;
	...
	int VAL_UCS2 = 152;
	int VAL_LATIN1 = 153;
	int VAL_UCS2LATIN1 = 154;
	int VAL_STORE = 155;
	int VAL_FORWARD = 156;
	int VAL_DATAGRAM = 157;
	int VAL_TX = 158;
	int VAL_RX = 159;
	int VAL_TRX = 160;
	int VAL_SMPP = 161;
