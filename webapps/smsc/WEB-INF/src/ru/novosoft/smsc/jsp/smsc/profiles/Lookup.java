...
public class Lookup extends PageBean {
    ...
    private String closedGroup = "";
    private String inputAccessMask = "";
    private String outputAccessMask = "";
    ...
    protected int init(final List errors) {
        ...
        try {
            if (!appContext.getHostsManager().getServiceInfo(Constants.SMSC_SME_ID).isOnline()) {
