...
public class SMSCErrors {
    ...
    public static class error {
        ...
        public static class closedgroups {
            private static final String B = error.B + "closedgroups.";
            public static final String couldntAlter = B + "couldntAlter";
            public static final String couldntDelete = B + "couldntDelete";
            public static final String couldntCreate = B + "couldntCreate";
            public static final String groupAlreadyExists = B + "groupAlreadyExists";
            public static final String nameNotDefined = B + "nameNotDefined";
            public static final String groupNotFound = B + "groupNotFound";
        }
        ...
        public static class smsc {
            ...
            public static final String couldntSwitchOver = B + "couldntSwitchOver";
            ...
            public static final String couldntGetState = B + "couldntGetState";
