...
public class SmsXSenderSoapBindingStub extends org.apache.axis.client.Stub implements SmsXSender {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(ru.novosoft.smsc.util.smsxsender.SmsXSenderResponse.class);
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://sibinco.ru/smsXSend", "DestinationAddress"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://sibinco.ru/smsXSend", "Message"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://sibinco.ru/smsXSend", "SMSXExpress"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"), boolean.class, false, false);
    ...
    public SmsXSenderSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public SmsXSenderSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public SmsXSenderSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = ru.novosoft.smsc.util.smsxsender.SmsXSenderResponse.class;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {MSISDN, message, new java.lang.Boolean(SMSXExpress), new java.lang.Boolean(SMSXSecret), new java.lang.Boolean(SMSXCalendar), new java.lang.Long(SMSXCalendarTimeUTC), new java.lang.Boolean(SMSXAdvertising)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (ru.novosoft.smsc.util.smsxsender.SmsXSenderResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (ru.novosoft.smsc.util.smsxsender.SmsXSenderResponse) org.apache.axis.utils.JavaUtils.convert(_resp, ru.novosoft.smsc.util.smsxsender.SmsXSenderResponse.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public ru.novosoft.smsc.util.smsxsender.SmsXSenderResponse sendPaidSms(java.lang.String sourceAddress, java.lang.String destinationAddress, java.lang.String message, boolean SMSXExpress, boolean SMSXSecret, boolean SMSXCalendar, long SMSXCalendarTimeUTC) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {sourceAddress, destinationAddress, message, new java.lang.Boolean(SMSXExpress), new java.lang.Boolean(SMSXSecret), new java.lang.Boolean(SMSXCalendar), new java.lang.Long(SMSXCalendarTimeUTC)});
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {SMSXIdMessage});
  ...
  throw axisFaultException;
    ...
    public int batchSecret(java.lang.String sourceAddress, java.lang.String message, boolean SMSXExpress, File destinations) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://sibinco.ru/smsXSend", "batchSecret"));

        DataHandler destFile = new DataHandler(new FileDataSource(destinations));
        AttachmentPart p = new AttachmentPart(destFile);
        p.setContentId("destinations");

        addAttachment(p);

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {sourceAddress, message, new java.lang.Boolean(SMSXExpress)});
  ...
  throw axisFaultException;
    ...
    public int sendSysSms(java.lang.String sourceAddress, java.lang.String destinationAddress, java.lang.String message) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://sibinco.ru/smsXSend", "sendSysSms"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {sourceAddress, destinationAddress, message});
