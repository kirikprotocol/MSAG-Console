...
public class SmsXSenderServiceLocator extends org.apache.axis.client.Service implements ru.novosoft.smsc.util.smsxsender.SmsXSenderService {
    ...
    private java.lang.String SmsXSender_address = "http://localhost:8080/smsx/services/SmsXSender";
    ...
    public SmsXSender getSmsXSender(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ru.novosoft.smsc.util.smsxsender.SmsXSenderSoapBindingStub _stub = new ru.novosoft.smsc.util.smsxsender.SmsXSenderSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SmsXSender.class.isAssignableFrom(serviceEndpointInterface)) {
                ru.novosoft.smsc.util.smsxsender.SmsXSenderSoapBindingStub _stub = new ru.novosoft.smsc.util.smsxsender.SmsXSenderSoapBindingStub(new java.net.URL(SmsXSender_address), this);
                _stub.setPortName(getSmsXSenderWSDDServiceName());
                return _stub;
            }
        }
