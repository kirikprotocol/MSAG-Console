...
class DeliveriesDiffHelper extends DiffHelper {
  ...
  void logDeliveryArchivated(Journal j, String user, int id, String deliveryName) throws AdminException {
    j.addRecord(JournalRecord.Type.CHANGE, subject, user, "delivery_archivated", Integer.toString(id), deliveryName);
  }
