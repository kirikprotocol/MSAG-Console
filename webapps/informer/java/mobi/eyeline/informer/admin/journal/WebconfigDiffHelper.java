...
public class WebconfigDiffHelper extends DiffHelper {
  ...
  public void logUpdateCdrProps(Journal journal, Properties props, Properties old, String user) throws AdminException {
    logMapsDiff(journal, subject, "cdr", old, props, user);
  }
