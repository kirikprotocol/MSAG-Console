...
class SimpleErrorStatsStrategy implements ErrorStatsStrategy{
  ...
  public void execute(Delivery delivery, User user, final ProgressListener progressListener) throws Exception {
    rowsMap.clear();
    MessageFilter filter = new MessageFilter(delivery.getId(), delivery.getCreateDate() == null ? delivery.getStartDate() : delivery.getCreateDate(), delivery.getEndDate() == null ? new Date() : delivery.getEndDate());
