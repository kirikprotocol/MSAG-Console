 ...
 */
public class AddDeliveryMessagesResp implements PDU {
  int seqNum;
  ...
  public AddDeliveryMessagesResp() {
  }
 

  public AddDeliveryMessagesResp(int seqNum, long []messageIds) {
  ...
  public String toString() {
    ...
    sb.append("AddDeliveryMessagesResp:");
    debug(sb);
    return sb.toString();
  }
  ...
  public void decode(BufferReader reader) throws IOException {
    while( true ) {
      ...
      switch( tag ) {
        ...
        default:
          throw new IOException( "unknown tagId: "+tag +" seqnum: "+seqNum +" msg: "+AddDeliveryMessagesResp.class.getName());      }
    }
  }
}
