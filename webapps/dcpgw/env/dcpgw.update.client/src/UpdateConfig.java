 ...
 */
public class UpdateConfig implements PDU {
  int seqNum;
  ...
  public UpdateConfig(int seqNum) {
  ...
  public void decode(BufferReader reader) throws IOException {
    while( true ) {
      ...
      switch( tag ) {
        default:
          throw new IOException( "unknown tagId: "+tag +" seqnum: "+seqNum +" msg: "+UpdateConfig.class.getName());      }
    }
  }
}
