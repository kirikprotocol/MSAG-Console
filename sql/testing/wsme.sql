...
--insert into wsme_langs (mask, lang) values ('.0.1.??', 'en_us');
insert into wsme_langs (mask, lang) values ('.0.1.1?', 'ru_ru');
insert into wsme_langs (mask, lang) values ('.0.1.11', 'en_gb');
...
insert into wsme_ad (id, lang, ad) values (3, 'en_gb', 'First en_gb ad: hello again!!!');
insert into wsme_ad (id, lang, ad) values (5, 'en_gb', 'First en_gb ad: hello again again!!!');
