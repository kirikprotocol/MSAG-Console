...
INSERT INTO WSME_VISITORS (MASK) VALUES ('.0.1.2');
INSERT INTO WSME_VISITORS (MASK) VALUES ('.0.1.3');
INSERT INTO WSME_VISITORS (MASK) VALUES ('.1.0.1?');

-- Add languagues for masks --

INSERT INTO WSME_LANGS (MASK, LANG) VALUES ('.0.1.3', 'EN/US');
INSERT INTO WSME_LANGS (MASK, LANG) VALUES ('.0.1.2', 'EN/EN');
