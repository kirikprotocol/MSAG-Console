...
import mobi.eyeline.mcahdb.engine.ds.impl.file.TestUtils;
...
public class StoreImplTest {
  ...
  public void testRead() throws DataSourceException, IOException {
    ...
    Collection<Event> events = store.getEvents("+79139031000", new Date(System.currentTimeMillis() - 3600000), new Date());
    for (Event e : events) {
