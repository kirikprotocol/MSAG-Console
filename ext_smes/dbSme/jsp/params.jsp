...
<%
	startSection(out, "DBSme", "DBSme", true);
		startParams(out);
            ...
            param(out, "maxMessagesPerSecond", "maxMessagesPerSecond", bean.getMaxMessagesPerSecond());
            param(out, "unrespondedMessagesMax", "unrespondedMessagesMax", bean.getUnrespondedMessagesMax());
        finishParams(out);
