...
class MessageSender {
  ...
  MessageSender(OutgoingQueue outQueue, SenderDataSource ds, int serviceId) {
    this.outQueue = outQueue;
    this.ds = ds;
    this.serviceId = serviceId;
    this.executor = new ThreadPoolExecutor(3, 10, 60L, TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(1000), new ThreadFactoryWithCounter("SenderMsgSender-Executor-"));
  }
