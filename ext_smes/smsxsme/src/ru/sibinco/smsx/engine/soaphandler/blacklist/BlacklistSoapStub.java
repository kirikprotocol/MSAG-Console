...
public class BlacklistSoapStub extends org.apache.axis.client.Stub implements BlacklistSoap {
  ...
  private static void _initOperationDesc1(){
    ...
    oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
    oper.setReturnClass(boolean.class);
    oper.setReturnQName(new javax.xml.namespace.QName("http://mts.qmobile.ru/api/", "CheckResult"));
    oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
    oper.setUse(org.apache.axis.constants.Use.LITERAL);
    _operations[2] = oper;
...
//    _call.setSOAPActionURI("http://mts.qmobile.ru/api/Remove");
  ...
  public boolean check(java.lang.String msisdn) throws java.rmi.RemoteException {
    if (super.cachedEndpoint == null) {
      throw new org.apache.axis.NoEndPointException();
    }
    org.apache.axis.client.Call _call = createCall();
...
//    _call.setSOAPActionURI("http://mts.qmobile.ru/api/Remove");
    ...
    _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
    _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
    _call.setOperationName(new javax.xml.namespace.QName("http://mts.qmobile.ru/api/", "Check"));
