...
<%@ page import="ru.sibinco.smsx.stats.beans.SmsxRegionsBean" %>
...
<%
  ...
  Set reports = bean.getReports();
	switch(beanResult)
	{
    case SmsxRegionsBean.RESULT_BACK:
      response.sendRedirect("index.jsp");
      return;
    case SmsxRegionsBean.RESULT_DOWNLOAD:
      response.sendRedirect(CPATH+"/esme_smsx/smsx_web_regions_csv.jsp?requestId="+requestId+"&region=" + (bean.getRegion() == null ? "" :URLEncoder.encode(bean.getRegion())) +
...
<div class=page_subtitle><%=getLocString("smsx.results.webRegions.title")+" ["+bean.getFrom()+'-'+bean.getTill()+']'%></div>
