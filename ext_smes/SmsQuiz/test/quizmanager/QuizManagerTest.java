...
public class QuizManagerTest {
  ...
  public static void init() {
    try {
      ...
      file.mkdirs();
      createQuizFile("test_QuizManager/opros_test.xml", 3, oa, da);
      createAbFile("test_QuizManager/opros_test_ab.csv", 7911, 15000, subscriptionManager);
      quizManager.start();
      waiting(initWait);
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public static void createQuizFile(String fileName, int minutes, String oa, String da) {
  ...
  public static void createAbFile(String fileName, long from, long till, SubscriptionManager subscriptionManager) {
    PrintWriter writer = null;
