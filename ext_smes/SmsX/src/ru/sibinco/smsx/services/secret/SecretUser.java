...
import ru.sibinco.smsx.utils.MessageEncoder;
...
final class SecretUser extends Storable {
  ...
  public void updatePassword(final String password) throws SQLException, MessageEncoder.EncodeException {
    ...
    try {
      ...
      ps = conn.prepareStatement(SecretService.Properties.SecretUser.UPDATE_PASSWORD_SQL);
  ...
  public void save() throws SQLException, MessageEncoder.EncodeException {
    ...
    try {
      conn = ConnectionPool.getConnection();
      ps = conn.prepareStatement(SecretService.Properties.SecretUser.INSERT_SQL);
  ...
  public void remove() throws SQLException {
    ...
    try {
      ...
      ps = conn.prepareStatement(SecretService.Properties.SecretUser.REMOVE_BY_NUMBER_SQL);
      ps.setString(1, number);
  ...
  public static SecretUser loadByNumber(final String number) throws SQLException {
    ...
    try {
      ...
      ps = conn.prepareStatement(SecretService.Properties.SecretUser.SELECT_BY_NUMBER_SQL);
      ps.setString(1, number);
