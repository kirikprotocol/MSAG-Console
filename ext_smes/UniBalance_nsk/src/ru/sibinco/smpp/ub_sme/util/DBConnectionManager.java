...
//      }
      ...
      if (shutdownTimeout > 0) config.setProperty(getName()+suffix+shutdownSuffix, Long.toString(getShutdownTimeout()));
      ...
      if (checkInterval > 0) config.setProperty(getName()+suffix+checkIntervalSuffix, Long.toString(getCheckInterval()));
