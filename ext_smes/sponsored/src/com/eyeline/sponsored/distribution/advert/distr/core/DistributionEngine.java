...
import com.eyeline.sme.utils.smpp.OutgoingObject;
...
public class DistributionEngine {
  ...
  public DistributionEngine(OutgoingQueue outQueue, DistributionDataSource distrDS, AdvertisingClient advClient) {
