...
subscription.lookupactives = SELECT id, subscriber_address, distribution_name, volume, start_date, end_date FROM subscriptions WHERE distribution_name=? AND (end_date IS NULL OR end_date > ?)
