...
for (Iterator i = c.iterator(); i.hasNext(); )
{
  ...
  if (bean.isTaskGenerating(taskId)){
    out.print("\"<span><img src='" + CPATH + "/img/ic_running.gif' title='generating'></span>\"");
    //out.print("generating");
  }else{
    out.print("\"<span><img src='" + CPATH + "/img/ic_stopped.gif' title='idle'></span>\"");
    //out.print("notGenerating");
  }

  out.print(", ");
  if (bean.isTaskProcessing(taskId)) {
    out.print("\"<span><img src='" + CPATH + "/img/ic_running.gif' title='processing'><span>\"");
