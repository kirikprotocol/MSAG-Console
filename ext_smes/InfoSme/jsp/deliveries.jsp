...
<tr class=row<%=rowN++&1%>>
  ...
  <td nowrap>
    <input class=calendarField id=startDate name=startDate value="<%=StringEncoderDecoder.encode(bean.getStartDate())%>" maxlength=20 style="z-index:22;"><button class=calendarButton type=button onclick="return showCalendar(startDate, false, true);">...</button>
  </td>
</tr>
<tr class=row<%=rowN++&1%>>
...
<div class=secInfo><%= ((bean.getStatus() == Deliveries.STATUS_DONE) ?
