...
import ru.sibinco.smpp.ub_sme.ComplexRequestStateIndex;
...
public class Utils {
     ...
     * @deprecated
     */
    public static List getSubList(ComplexRequestStateIndex index, List list) {
        List returnList = new LinkedList();
        if (null == index) return returnList;
