...
public class ProductivityController extends Thread {
  ...
  public void addControlObject(ru.sibinco.smpp.ub_sme.util.ProductivityControllable obj) {
  ...
  public void run() {
    while (!stop) {
      for (int i = 0; i < controlObjects.size(); i++) {
        ru.sibinco.smpp.ub_sme.util.ProductivityControllable object = (ru.sibinco.smpp.ub_sme.util.ProductivityControllable) controlObjects.get(i);
