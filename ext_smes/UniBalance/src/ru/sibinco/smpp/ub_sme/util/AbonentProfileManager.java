 ...
 * Time: 21:19:42
 */
public class AbonentProfileManager {
  private final static org.apache.log4j.Category logger = org.apache.log4j.Category.getInstance(AbonentProfileManager.class);
  ...
  private static AbonentProfileManager abonentProfileManager;
  private int connectTimeout;
  private int readTimeout;

  public AbonentProfileManager(Properties config) {
    ...
    if (logger.isDebugEnabled()) {
      logger.debug("AbonentProfileManager inited");
    }
  }

  public static void init(Properties config) {
    abonentProfileManager = new AbonentProfileManager(config);
  }

  public static AbonentProfileManager getProfileAbonentLang() {
    return abonentProfileManager;
  }
