...
public class StressTest implements InManPDUHandler {
  ...
  private ru.sibinco.smpp.ub_sme.util.ProductivityController pcontroller;
  private ProductivityControlObject senderSpeed = new ru.sibinco.smpp.ub_sme.util.ProductivityControlObject("Sender");
  private ru.sibinco.smpp.ub_sme.util.ProductivityControlObject receiverSpeed = new ru.sibinco.smpp.ub_sme.util.ProductivityControlObject("Receiver");
  ...
  private void init(Properties config) throws InitializationException {
    ...
    pcontroller = new ru.sibinco.smpp.ub_sme.util.ProductivityController();
