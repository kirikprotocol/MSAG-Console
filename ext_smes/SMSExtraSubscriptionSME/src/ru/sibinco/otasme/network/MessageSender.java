...
public class MessageSender extends Service {
  ...
  public void  iterativeWork() {
    ...
    try {
      ...
      if (!validateMessage(msg)) {
        Log.error("Message " + msg.getMessageString() + " is invalid");
        return;
      }

      final Connector connector = lookupConnector(msg);
  ...
  public boolean canSendMessage(final Message message) {
    return validateMessage(message) && lookupConnector(message) != null;
  }
