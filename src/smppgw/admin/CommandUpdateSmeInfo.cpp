...
// Constructor
///
CommandUpdateSmeInfo::CommandUpdateSmeInfo(const xercesc::DOMDocument * document)
  : Command((Command::Id)CommandIds::updateSmeInfo)
{
...
// Destructor
//
CommandUpdateSmeInfo::~CommandUpdateSmeInfo()
{
}
