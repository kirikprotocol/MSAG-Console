  ...
  */
  ...
  if(isrcpt)
  {
    ...
    *pdu_ptr++=sms->getMessageReference();
    ...
    {
      throw MAPDIALOG_ERROR(MAKE_ERRORCODE(CMD_ERR_PERM,smsc::Status::INVESMCLASS),"receipt without recipient address");
    }
...
//    time(&t);
    int abonentsTz=smsc::common::TimeZoneManager::getInstance().getTimeZone(sms->getOriginatingAddress());
