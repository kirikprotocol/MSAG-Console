...
#include "smsc/snmp/SnmpAgent.hpp"
#endif
...
static void KillProxy(int ct,SmppProxy* proxy,SmeManager* smeManager)
{
  ...
  {
#ifdef SNMP
    smsc::snmp::SnmpCounter::SmeTrapSeverities smeTrpSvrt=smsc::snmp::SnmpCounter::getInstance().getSmeSeverities(sysId.c_str());
#endif
    try{
#ifdef SNMP
      if(ct==ctTransceiver)
            ...
            switch(pdu->get_commandId())
            {
              ...
              case SmppCommandSet::BIND_TRANCIEVER:
              {
                  ...
                  )
                {
                  ...
                  {
                    smsc::snmp::SnmpCounter::getInstance().incCounter(smsc::snmp::SnmpCounter::cntErr0xd,ss->getProxy()->getSystemId());
                  }
#endif
...
#ifdef SNMP
                  smsc::snmp::SnmpCounter::SmeTrapSeverities trpSvrt=smsc::snmp::SnmpCounter::getInstance().getSmeSeverities(sid.c_str());
                ...
                {
                  smsc::snmp::SnmpCounter::getInstance().incCounter(smsc::snmp::SnmpCounter::cntErr0xd,sid.c_str());
                }
#endif
