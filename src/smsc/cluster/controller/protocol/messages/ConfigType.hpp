#ifndef __GENERATED_ENUM_SMSC_CLUSTER_CONTROLLER_PROTOCOL_MESSAGES_CONFIGTYPE__
#define __GENERATED_ENUM_SMSC_CLUSTER_CONTROLLER_PROTOCOL_MESSAGES_CONFIGTYPE__
