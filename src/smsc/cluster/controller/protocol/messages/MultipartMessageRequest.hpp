#ifndef __GENERATED_MESSAGE_SMSC_CLUSTER_CONTROLLER_PROTOCOL_MESSAGES_MULTIPARTMESSAGEREQUEST_HPP__
#define __GENERATED_MESSAGE_SMSC_CLUSTER_CONTROLLER_PROTOCOL_MESSAGES_MULTIPARTMESSAGEREQUEST_HPP__
...
#ident "@(#) MultipartMessageRequest version 1.0"
...
class MultipartMessageRequest{
public:
  MultipartMessageRequest()
  {
    Clear();
  }
  void Clear()
  ...
  void deserialize(DataStream& ds)
  {
    ...
    //{
    //  throw protogen::framework::IncompatibleVersionException("MultipartMessageRequest");
    //}
    //seqNum=ds.readInt32();
    while(!endOfMessage)
    {
      ...
      switch(tag)
      {
        ...
        default:
          ...
          //{
          //  throw protogen::framework::UnexpectedTag("MultipartMessageRequest",tag);
          //}
