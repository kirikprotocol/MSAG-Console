...
#include "smsc/dpf/dpfTracker.hpp"
...
public:
  ...
  struct ReplaceIfPresentKey{
    Address org;
    Address dst;
    buf::FixedLengthString<6> esvctype;
...
public:
  ...
  buf::CyclicQueue<SchedulerData> firstQueue;
  TimeLine timeLine;
