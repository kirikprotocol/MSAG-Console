...
{
	__trace2__("putProfile(): addr = %s, codepage = %d, reportoptions = %d, locale = %s, hide = %d, hideModifiable = %s",
		str(addr).c_str(), profile.codepage, profile.reportoptions, profile.locale.c_str(), profile.hide, profile.hideModifiable ? "true" : "false");
