...
/**
 * ‘лаг задающий выполнение случайной тестовой процедуры в рамках тест кейса.
 */
const int RAND_TC = -1;

/**
 * ‘лаг задающий выполнение всех тестовых процедур, случайной тестовой процедуры,
 * неупор€доченного набора случайных тестовых процедур или вообще ничего в 
 * рамках тест кейса.
 */
...
static const char* rusChars = "јЅ¬√ƒ≈®∆«»… ЋћЌќѕ–—“”‘’÷„ЎўЏџ№ЁёяабвгдеЄжзийклмнопрстуфхцчшщъыьэю€";
...
private:
	int* val;
	int pos; //текуща€ позици€ по массиву val
	int size;
	int choice;
