...
void submitSmTc()
{
	...
	__reg_tc__("submitSm.mapSpecial",
		"Отправка специальных сообщений на MAP_PROXY");
	__reg_tc__("submitSm.mapSpecial.noPorts",
		"Не заданы оба source_port и dest_port не зависимо от udh");
	__reg_tc__("submitSm.mapSpecial.missingPort",
		"Не задан один из source_port или dest_port, udh не установлен");
	__reg_tc__("submitSm.mapSpecial.8bitPort",
		"Заданы оба source_port и dest_port со значениями меньше 255, udh не установлен");
	__reg_tc__("submitSm.mapSpecial.16bitPort",
		"Заданы оба source_port и dest_port со значениями одного или обоих портов больше 255, udh не установлен");
	__reg_tc__("submitSm.mapSpecial.udhi&Ports",
		"Заданы оба source_port и dest_port и установлен udh");
	__reg_tc__("submitSm.mapSpecial.mobileEquipmentNoPorts",
		"Отправка длинных сообщений (с нарезкой) с больной sme с data_coding = 0xF5 (binary, dest_addr_subunit = Mobile Equipment) с незаданными source_port и destination_port");
	__reg_tc__("submitSm.mapSpecial.mobileEquipmentWithPorts",
		"Отправка длинных сообщений (с нарезкой) с больной sme с data_coding = 0xF5 (binary, dest_addr_subunit = Mobile Equipment) с установленными source_port и destination_port");
	//submitSm.incorrect
...
void normalSmsTc()
{
	...
	__reg_tc__("sms.normalSms.map.checkMobileEquipment",
		"Для сообщения отправленного с больной sme c data_coding = 0xf5, если присутствуют опциональные поля source_port и destination_port, то эти поля проносятся в udhi");
