...
const char * getAssociationStateDescription(UCHAR_T state) {
  switch(state) {
    case    0: return "Association Down";
    case    1: return "Wait Establish";
    case    2: return "Wait Shutdown";
    case    3: return "Established";
    case    4: return "Send Established To Inactive (ASUP sent)";
    case    5: return "Send Inactive To Established (ASPDN sent)";
    case    6: return "Association Inactive";
    case    7: return "Send Inactive To Active (ASPAC sent)";
    case    8: return "Send Active To Inactive (ASPIA sent)";
    case    9: return "Association Active";
    default  : return "UNKNOWN";
  }
}

const char * getTypeOfServiceDescription(UCHAR_T typeOfService) {
...
std::string getAlarmResultDescription(UCHAR_T noOfAlarms, ALARMS_T *alarms_sp)
{
  string res="";
  char tmp[32] = {0,}; int k;
  ...
  {
    k = sprintf(tmp,"%d",alarms_sp[i].alarmId); tmp[k] = 0;
    res+="{id=";res+=tmp;res+=",res=";res+=getResultDescription(alarms_sp[i].alarmResult);res+="}";
  }
  return res;
}
