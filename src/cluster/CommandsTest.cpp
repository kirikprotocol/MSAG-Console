...
int main(int argc, char* argv[])
{
    ...
    printf("\naclCreateCommand:\n");
    AclCreateCommand aclCreateCmd(name, desc, type, 0,phones);
    ...
    printf("\nMemAddMemberCommand:\n");
    checkCommand<MemAddMemberCommand>(0,std::string("name"), std::string("address"));
    ...
    checkCommand<MscRegistrateCommand>("mscNum",0);

    printf("\nMscUnregisterCommand:\n");
    checkCommand<MscUnregisterCommand>("mscNum");

    printf("\nPrcAddPrincipalCommand:\n");
    checkCommand<PrcAddPrincipalCommand>(10, 5329, 0,"address");
...

    {
        ...
        checkCommand<ProfileUpdateCommand>("1",smsc::profiler::Profile());
    }

    printf("\nSbmAddSubmiterCommand:\n");
    checkCommand<SbmAddSubmiterCommand>(0,"name", "address");
