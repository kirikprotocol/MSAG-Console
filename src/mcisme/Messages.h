...
/* -------------------------- ��������� ��� ������� ��������� -------------------------- */
extern const char* MSG_TEMPLATE_PARAM_ABONENT; // ���� ���������� ��������� (i|n)
extern const char* MSG_TEMPLATE_PARAM_TOTAL;   // ����� ���������� �������  (i)
extern const char* MSG_TEMPLATE_PARAM_ROWS;    // ������ ���������          (i)
    
/* -------------------------- ��������� ��� ������� ������ -------------------------- */
extern const char* MSG_TEMPLATE_PARAM_CALLER;  // ����� ���������� �������� (i)
extern const char* MSG_TEMPLATE_PARAM_COUNT;   // ���������� ������� �� ��������, if (single) => 1 (i)
extern const char* MSG_TEMPLATE_PARAM_DATE;    // ���� ������/���� ���������� ������ (i)
