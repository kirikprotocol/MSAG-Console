...
public:
	...
	virtual void addEvent(const AbntAddr& CalledNum, const MCEvent& event, time_t schedTime = 0) = 0;
	virtual void setSchedTime(const AbntAddr& CalledNum, time_t schedTime) = 0;
