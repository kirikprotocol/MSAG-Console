#ifndef __MCISME_ADVERT_BEPROTOCOLV3SIMPLECLIENT_HPP__
# define __MCISME_ADVERT_BEPROTOCOLV3SIMPLECLIENT_HPP__
...
class BEProtocolV3SimpleClient : public AdvertisingImpl {
public:
  BEProtocolV3SimpleClient(const std::string& host, int port);

  static const unsigned int PROTOCOL_VERSION = 3;
...
protected:
  ...
  enum {
    ...
    ROTATOR_ID_TAG = 0x0E, OWNER_ID_TAG = 0x0F, BANNER_ERRCODE_TAG = 0x15
  };
};
