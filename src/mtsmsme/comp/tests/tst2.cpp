...
void AmericaTestFixture::updateLocation_arg_encoding()
{
  ...
  unsigned char etalon_with_camel[] = {
  ...
  unsigned char etalon[] = {
    0x62, 0x50/*ch*/, 0x48, 0x04, 0xba, 0xbe, 0x00, 0x16,
    0x6b, 0x1e, 0x28, 0x1c, 0x06, 0x07, 0x00, 0x11,
    0x86, 0x05, 0x01, 0x01, 0x01, 0xa0, 0x11, 0x60,
    0x0f, 0x80, 0x02, 0x07, 0x80, 0xa1, 0x09, 0x06,
    0x07, 0x04, 0x00, 0x00, 0x01, 0x00, 0x01, 0x02,
    0x6c, 0x28/*ch*/, 0xa1, 0x26/*ch*/, 0x02, 0x01, 0x01, 0x02,
    0x01, 0x02, 0x30, 0x1e/*ch*/, 0x04, 0x08, 0x72, 0x02,
    0x71, 0x10, 0x51, 0x12, 0x96, 0xf1, 0x81, 0x07,
    0x91, 0x97, 0x31, 0x89, 0x96, 0x89, 0x21, 0x04,
    0x07, 0x91, 0x97, 0x31, 0x89, 0x96, 0x89, 0x31,
    0xa6, 0x00/* 0x04, 0x80, 0x02, 0x05, 0x80*/
  };
  unsigned char bad[] = {
    0x62, 0x54, 0x48, 0x04, 0xba, 0xbe, 0x00, 0x16,
    0x6b, 0x1e, 0x28, 0x1c, 0x06, 0x07, 0x00, 0x11,
...
void AmericaTestFixture::sms_status_report_receiving(void)
{
  ...
  uint8_t cdlen = 0x0b;/*,*/
  uint8_t cd[] = { 0x12, 0x08, 0x00, 0x11, 0x04,
  0x97, 0x31, 0x89, 0x06, 0x00, 0x04 };/*,*/
  uint8_t cglen = 0x0b;/*,*/
  uint8_t cg[] = { 0x12, 0x08, 0x00, 0x11, 0x04,
  0x97, 0x31, 0x89, 0x96, 0x99, 0x09 };/*,*/
  uint8_t udlen = 0x62;/*,*/
  uint8_t ud[] = {
  0x62, 0x60, 0x48, 0x04, 0x1a, 0x3e, 0x00, 0x00,
  0x6b, 0x1e, 0x28, 0x1c, 0x06, 0x07, 0x00, 0x11,
  0x86, 0x05, 0x01, 0x01, 0x01, 0xa0, 0x11, 0x60,
  0x0f, 0x80, 0x02, 0x07, 0x80, 0xa1, 0x09, 0x06,
  0x07, 0x04, 0x00, 0x00, 0x01, 0x00, 0x19, 0x02,
  0x6c, 0x38, 0xa1, 0x36, 0x02, 0x01, 0x01, 0x02,
  0x01, 0x2e, 0x30, 0x2e, 0x80, 0x08, 0x52, 0x00,
  0x31, 0x09, 0x41, 0x46, 0x52, 0xf1, 0x84, 0x07,
  0x91, 0x97, 0x31, 0x89, 0x96, 0x99, 0xf9, 0x04,
  0x19, 0x06, 0x80, 0x0b, 0x91, 0x97, 0x31, 0x89,
  0x95, 0x84, 0xf9, 0x01, 0x01, 0x22, 0x71, 0x33,
  0x52, 0x82, 0x01, 0x01, 0x22, 0x71, 0x33, 0x72,
  0x82, 0x00 };
  char msc[] = "791398600223"; // MSC address
  char vlr[] = "79139860004"; //VLR address
  char hlr[] = "79139860004"; //HLR address
  ...
  TCO mtsms(10);
  mtsms.setAdresses(Address((uint8_t) strlen(msc), 1, 1, msc), Address(
      (uint8_t) strlen(vlr), 1, 1, vlr), Address((uint8_t) strlen(hlr), 1, 1,
      hlr));
  ...
  mtsms.NUNITDATA(cdlen, cd, cglen, cg, udlen, ud);
  uint8_t expected_data[] = {
    0x64, 0x39, 0x49, 0x04, 0x1a, 0x3e, 0x00, 0x00,
    0x6b, 0x2a, 0x28, 0x28, 0x06, 0x07, 0x00, 0x11,
    0x86, 0x05, 0x01, 0x01, 0x01, 0xa0, 0x1d, 0x61,
    0x1b, 0x80, 0x02, 0x07, 0x80, 0xa1, 0x09, 0x06,
    0x07, 0x04, 0x00, 0x00, 0x01, 0x00, 0x19, 0x02,
