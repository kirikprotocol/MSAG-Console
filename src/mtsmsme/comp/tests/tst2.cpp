...
void AmericaTestFixture::sendRoutingInfo_res_decoding()
{
  ...
  /*
  64  64  49  04  03  00  00  00
  6b  2a  28  28  06  07  00  11
  86  05  01  01  01  a0  1d  61
  1b  80  02  07  80  a1  09  06
  07  04  00  00  01  00  05  03
  a2  03  02  01  00  a3  05  a1
  03  02  01  00  6c  80
  a2  2c
  02  01  01  30  27  02  01  16
  a3  80  89  08  52  00  31  03
  10  90  88  f6  04  07  91  97
  31  04  99  78  f0  82  07  91
  97  31  03  99  99  f2  8f  02
  04  e0  00  00  00  00
  */
  uint8_t encoded_data[] = {
  //0xa2, 0x2c, 0x02, 0x01, 0x01, 0x30, 0x27, 0x02,
  //0x01, 0x16,
                0xa3, 0x80, 0x89, 0x08, 0x52, 0x00,
