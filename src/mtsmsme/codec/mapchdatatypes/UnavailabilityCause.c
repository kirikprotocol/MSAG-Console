...
static asn_INTEGER_enum_map_t asn_MAP_UnavailabilityCause_value2enum_1[] = {
...
static unsigned int asn_MAP_UnavailabilityCause_enum2value_1[] = {
...
static asn_INTEGER_specifics_t asn_SPC_UnavailabilityCause_specs_1 = {
	asn_MAP_UnavailabilityCause_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_UnavailabilityCause_enum2value_1,	/* N => "tag"; sorted by N */
	6,	/* Number of elements in the maps */
	7,	/* Extensions before this member */
	1	/* Strict enumeration */
};
static ber_tlv_tag_t asn_DEF_UnavailabilityCause_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_UnavailabilityCause = {
	...
	asn_DEF_UnavailabilityCause_tags_1,
	sizeof(asn_DEF_UnavailabilityCause_tags_1)
		/sizeof(asn_DEF_UnavailabilityCause_tags_1[0]), /* 1 */
	asn_DEF_UnavailabilityCause_tags_1,	/* Same as above */
	sizeof(asn_DEF_UnavailabilityCause_tags_1)
		/sizeof(asn_DEF_UnavailabilityCause_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	0, 0,	/* Defined elsewhere */
	&asn_SPC_UnavailabilityCause_specs_1	/* Additional specs */
};
