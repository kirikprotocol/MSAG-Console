...
static ber_tlv_tag_t asn_DEF_CUG_CheckInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CUG_CheckInfo_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_CUG_CheckInfo_specs_1 = {
	sizeof(struct CUG_CheckInfo),
	offsetof(struct CUG_CheckInfo, _asn_ctx),
	asn_MAP_CUG_CheckInfo_tag2el_1,
...
asn_TYPE_descriptor_t asn_DEF_CUG_CheckInfo = {
	...
	asn_DEF_CUG_CheckInfo_tags_1,
	sizeof(asn_DEF_CUG_CheckInfo_tags_1)
		/sizeof(asn_DEF_CUG_CheckInfo_tags_1[0]), /* 1 */
	asn_DEF_CUG_CheckInfo_tags_1,	/* Same as above */
	sizeof(asn_DEF_CUG_CheckInfo_tags_1)
		/sizeof(asn_DEF_CUG_CheckInfo_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_CUG_CheckInfo_1,
	3,	/* Elements count */
	&asn_SPC_CUG_CheckInfo_specs_1	/* Additional specs */
};
