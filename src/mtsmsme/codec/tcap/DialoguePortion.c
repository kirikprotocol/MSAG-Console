...
DialoguePortion_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	...
	td->uper_decoder   = asn_DEF_EXT.uper_decoder;
	td->uper_encoder   = asn_DEF_EXT.uper_encoder;
	if(!td->per_constraints)
		td->per_constraints = asn_DEF_EXT.per_constraints;
...
asn_TYPE_descriptor_t asn_DEF_DialoguePortion = {
	...
	sizeof(asn_DEF_DialoguePortion_tags_1)
		/sizeof(asn_DEF_DialoguePortion_tags_1[0]) - 1, /* 2 */
	asn_DEF_DialoguePortion_tags_1,	/* Same as above */
	sizeof(asn_DEF_DialoguePortion_tags_1)
		/sizeof(asn_DEF_DialoguePortion_tags_1[0]), /* 3 */
