...
static asn_TYPE_member_t asn_MBR_abrt_user_information_3[] = {
	{ ATF_POINTER, 0, 0,
...
static ber_tlv_tag_t asn_DEF_abrt_user_information_tags_3[] = {
	(ASN_TAG_CLASS_CONTEXT | (30 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_abrt_user_information_specs_3 = {
	sizeof(struct abrt_user_information),
	offsetof(struct abrt_user_information, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_abrt_user_information_3 = {
	...
	asn_DEF_abrt_user_information_tags_3,
	sizeof(asn_DEF_abrt_user_information_tags_3)
		/sizeof(asn_DEF_abrt_user_information_tags_3[0]) - 1, /* 1 */
	asn_DEF_abrt_user_information_tags_3,	/* Same as above */
	sizeof(asn_DEF_abrt_user_information_tags_3)
		/sizeof(asn_DEF_abrt_user_information_tags_3[0]), /* 2 */
	0,	/* No PER visible constraints */
	asn_MBR_abrt_user_information_3,
	1,	/* Single element */
	&asn_SPC_abrt_user_information_specs_3	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_ABRT_apdu_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ABRT_apdu, abrt_user_information),
		(ASN_TAG_CLASS_CONTEXT | (30 << 2)),
		0,
		&asn_DEF_abrt_user_information_3,
		0,	/* Defer constraints checking to the member type */
		0,	/* PER is not compiled, use -gen-PER */
		0,
		"abrt-user-information"
...
static asn_TYPE_tag2member_t asn_MAP_ABRT_apdu_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* abort-source at 52 */
    { (ASN_TAG_CLASS_CONTEXT | (30 << 2)), 1, 0, 0 } /* abrt-user-information at 53 */
};
