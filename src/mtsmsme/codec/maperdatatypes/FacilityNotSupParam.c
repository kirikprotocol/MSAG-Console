...
static asn_TYPE_tag2member_t asn_MAP_FacilityNotSupParam_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 0 }, /* extensionContainer at 140 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 }, /* shapeOfLocationEstimateNotSupported at 142 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 2, 0, 0 } /* neededLcsCapabilityNotSupportedInServingNode at 143 */
};
