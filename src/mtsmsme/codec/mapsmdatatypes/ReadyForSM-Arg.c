...
static asn_TYPE_member_t asn_MBR_ReadyForSM_Arg_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct ReadyForSM_Arg, alertReasonIndicator),
	...
	{ ATF_POINTER, 1, offsetof(struct ReadyForSM_Arg, extensionContainer),
...
static asn_TYPE_tag2member_t asn_MAP_ReadyForSM_Arg_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (5 << 2)), 2, 0, 0 }, /* alertReasonIndicator at 210 */
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 1, 0, 0 }, /* alertReason at 209 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, 0, 0 }, /* extensionContainer at 213 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* imsi at 208 */
};
