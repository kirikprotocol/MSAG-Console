...
static asn_INTEGER_enum_map_t asn_MAP_AdditionalNetworkResource_value2enum_1[] = {
	{ 0,	4,	"sgsn" },
	{ 1,	4,	"ggsn" },
	{ 2,	4,	"gmlc" },
	{ 3,	6,	"gsmSCF" },
...
static unsigned int asn_MAP_AdditionalNetworkResource_enum2value_1[] = {
	5,	/* auc(5) */
	1,	/* ggsn(1) */
	2,	/* gmlc(2) */
	3,	/* gsmSCF(3) */
...
static asn_INTEGER_specifics_t asn_SPC_AdditionalNetworkResource_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_AdditionalNetworkResource_tags_1[] = {
