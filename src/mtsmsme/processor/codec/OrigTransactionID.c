 ...
 */
static void
OrigTransactionID_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
OrigTransactionID_free(asn_TYPE_descriptor_t *td,
  ...
  OrigTransactionID_inherit_TYPE_descriptor(td);
...
static ber_tlv_tag_t asn_DEF_OrigTransactionID_tags[] = {
...
asn_TYPE_descriptor_t asn_DEF_OrigTransactionID = {
  ...
  asn_DEF_OrigTransactionID_tags,
  sizeof(asn_DEF_OrigTransactionID_tags)
    /sizeof(asn_DEF_OrigTransactionID_tags[0]) - 1, /* 1 */
  asn_DEF_OrigTransactionID_tags, /* Same as above */
  sizeof(asn_DEF_OrigTransactionID_tags)
    /sizeof(asn_DEF_OrigTransactionID_tags[0]), /* 2 */
  0, 0, /* No members */
  0 /* No specifics */
};
