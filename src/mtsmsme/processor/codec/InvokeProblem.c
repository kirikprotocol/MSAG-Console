 ...
 */
static void
InvokeProblem_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
InvokeProblem_free(asn_TYPE_descriptor_t *td,
  ...
  InvokeProblem_inherit_TYPE_descriptor(td);
...
static ber_tlv_tag_t asn_DEF_InvokeProblem_tags[] = {
...
asn_TYPE_descriptor_t asn_DEF_InvokeProblem = {
  ...
  asn_DEF_InvokeProblem_tags,
  sizeof(asn_DEF_InvokeProblem_tags)
    /sizeof(asn_DEF_InvokeProblem_tags[0]), /* 1 */
  asn_DEF_InvokeProblem_tags, /* Same as above */
  sizeof(asn_DEF_InvokeProblem_tags)
    /sizeof(asn_DEF_InvokeProblem_tags[0]), /* 1 */
  0, 0, /* No members */
  0 /* No specifics */
