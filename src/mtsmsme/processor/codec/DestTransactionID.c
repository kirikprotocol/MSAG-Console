 ...
 */
static void
DestTransactionID_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
DestTransactionID_free(asn_TYPE_descriptor_t *td,
  ...
  DestTransactionID_inherit_TYPE_descriptor(td);
...
static ber_tlv_tag_t asn_DEF_DestTransactionID_tags[] = {
...
asn_TYPE_descriptor_t asn_DEF_DestTransactionID = {
  ...
  asn_DEF_DestTransactionID_tags,
  sizeof(asn_DEF_DestTransactionID_tags)
    /sizeof(asn_DEF_DestTransactionID_tags[0]) - 1, /* 1 */
  asn_DEF_DestTransactionID_tags, /* Same as above */
  sizeof(asn_DEF_DestTransactionID_tags)
    /sizeof(asn_DEF_DestTransactionID_tags[0]), /* 2 */
  0, 0, /* No members */
  0 /* No specifics */
};
