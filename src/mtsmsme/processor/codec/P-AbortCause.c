 ...
 */
static void
P_AbortCause_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
P_AbortCause_free(asn_TYPE_descriptor_t *td,
  ...
  P_AbortCause_inherit_TYPE_descriptor(td);
...
static ber_tlv_tag_t asn_DEF_P_AbortCause_tags[] = {
...
asn_TYPE_descriptor_t asn_DEF_P_AbortCause = {
  ...
  asn_DEF_P_AbortCause_tags,
  sizeof(asn_DEF_P_AbortCause_tags)
    /sizeof(asn_DEF_P_AbortCause_tags[0]) - 1, /* 1 */
  asn_DEF_P_AbortCause_tags,  /* Same as above */
  sizeof(asn_DEF_P_AbortCause_tags)
    /sizeof(asn_DEF_P_AbortCause_tags[0]), /* 2 */
  0, 0, /* No members */
  0 /* No specifics */
};
