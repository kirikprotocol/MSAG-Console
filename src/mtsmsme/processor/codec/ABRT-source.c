 ...
 */
static void
ABRT_source_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
ABRT_source_free(asn_TYPE_descriptor_t *td,
  ...
  ABRT_source_inherit_TYPE_descriptor(td);
...
static ber_tlv_tag_t asn_DEF_ABRT_source_tags[] = {
...
asn_TYPE_descriptor_t asn_DEF_ABRT_source = {
  ...
  asn_DEF_ABRT_source_tags,
  sizeof(asn_DEF_ABRT_source_tags)
    /sizeof(asn_DEF_ABRT_source_tags[0]), /* 1 */
  asn_DEF_ABRT_source_tags, /* Same as above */
  sizeof(asn_DEF_ABRT_source_tags)
    /sizeof(asn_DEF_ABRT_source_tags[0]), /* 1 */
  0, 0, /* No members */
  0 /* No specifics */
