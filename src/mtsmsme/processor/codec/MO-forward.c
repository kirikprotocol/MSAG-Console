...
static asn_TYPE_tag2member_t asn_MAP_sm_RP_DA_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* imsi at 188 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* lmsi at 189 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 2, 0, 0 }, /* serviceCentreAddressDA at 190 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 3, 0, 0 } /* noSM-RP-DA at 191 */
};
...
static asn_TYPE_tag2member_t asn_MAP_sm_RP_OA_tag2el_7[] = {
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 0, 0, 0 }, /* msisdn at 194 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 1, 0, 0 }, /* serviceCentreAddressOA at 195 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 2, 0, 0 } /* noSM-RP-OA at 196 */
};
...
static asn_TYPE_member_t asn_MBR_MO_forward_1[] = {
...
static ber_tlv_tag_t asn_DEF_MO_forward_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MO_forward_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (4 << 2)), 2, 0, 0 }, /* sm-RP-UI at 198 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* imsi at 188 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 0, 0, 0 }, /* lmsi at 189 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 1, 0, 0 }, /* msisdn at 194 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 0, 0, 1 }, /* serviceCentreAddressDA at 190 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 1, -1, 0 }, /* serviceCentreAddressOA at 195 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 0, 0, 1 }, /* noSM-RP-DA at 191 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 1, -1, 0 } /* noSM-RP-OA at 196 */
};
static asn_SEQUENCE_specifics_t asn_SPC_MO_forward_specs_1 = {
	sizeof(struct MO_forward),
	offsetof(struct MO_forward, _asn_ctx),
	asn_MAP_MO_forward_tag2el_1,
...
asn_TYPE_descriptor_t asn_DEF_MO_forward = {
	...
	asn_DEF_MO_forward_tags_1,
	sizeof(asn_DEF_MO_forward_tags_1)
		/sizeof(asn_DEF_MO_forward_tags_1[0]), /* 1 */
	asn_DEF_MO_forward_tags_1,	/* Same as above */
	sizeof(asn_DEF_MO_forward_tags_1)
		/sizeof(asn_DEF_MO_forward_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_MO_forward_1,
	3,	/* Elements count */
	&asn_SPC_MO_forward_specs_1	/* Additional specs */
};
