 ...
 */
static void
Associate_result_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
Associate_result_free(asn_TYPE_descriptor_t *td,
  ...
  Associate_result_inherit_TYPE_descriptor(td);
...
static ber_tlv_tag_t asn_DEF_Associate_result_tags[] = {
...
asn_TYPE_descriptor_t asn_DEF_Associate_result = {
  ...
  asn_DEF_Associate_result_tags,
  sizeof(asn_DEF_Associate_result_tags)
    /sizeof(asn_DEF_Associate_result_tags[0]), /* 1 */
  asn_DEF_Associate_result_tags,  /* Same as above */
  sizeof(asn_DEF_Associate_result_tags)
    /sizeof(asn_DEF_Associate_result_tags[0]), /* 1 */
  0, 0, /* No members */
  0 /* No specifics */
