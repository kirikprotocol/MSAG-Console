...
static asn_TYPE_tag2member_t asn_MAP_ExtensionContainer_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* privateExtensionList at 29 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* pcs-Extensions at 30 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ExtensionContainer_specs_1 = {
	sizeof(struct ExtensionContainer),
	offsetof(struct ExtensionContainer, _asn_ctx),
	asn_MAP_ExtensionContainer_tag2el_1,
...
asn_TYPE_descriptor_t asn_DEF_ExtensionContainer = {
	...
	2,	/* Elements count */
	&asn_SPC_ExtensionContainer_specs_1	/* Additional specs */
};
