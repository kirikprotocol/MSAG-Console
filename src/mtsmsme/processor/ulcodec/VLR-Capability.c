...
static asn_TYPE_tag2member_t asn_MAP_VLR_Capability_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, 0, 0 }, /* extensionContainer at 60 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* supportedCamelPhases at 59 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 3, 0, 0 }, /* istSupportIndicator at 63 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* solsaSupportIndicator at 62 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 4, 0, 0 }, /* superChargerSupportedInServingNetworkEntity at 64 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 5, 0, 0 }, /* longFTN-Supported at 65 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 6, 0, 0 }, /* supportedLCS-CapabilitySets at 66 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 7, 0, 0 } /* offeredCamel4CSIs at 67 */
};
