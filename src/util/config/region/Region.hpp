...
public:
  ...
  Region(const std::string& id="", const std::string& name="", ulong_t bandwidth=0, subjects_ids_lst_t subjects_ids=subjects_ids_lst_t());
...
{
public:
  RegionDefault(ulong_t bandwidth=0)
    : Region("regDefault", "default region", bandwidth) {}
};
}}}}
