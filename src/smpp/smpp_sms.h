...
inline void fillOptional(SmppOptional& optional,SMS* sms,uint32_t smeFlags=0) //==ucs2
{
...
inline bool fillSmppPduFromSms(PduXSm* pdu,SMS* sms,uint32_t smeFlags=0) //==ucs2
{
  using namespace smsc::smeman;
