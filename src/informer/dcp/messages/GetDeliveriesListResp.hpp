#ifndef __GENERATED_MESSAGE_EYELINE_INFORMER_DCP_MESSAGES_GETDELIVERIESLISTRESP_HPP__
#define __GENERATED_MESSAGE_EYELINE_INFORMER_DCP_MESSAGES_GETDELIVERIESLISTRESP_HPP__
...
#ident "@(#) GetDeliveriesListResp version 1.0"
...
class GetDeliveriesListResp{
public:
  GetDeliveriesListResp()
  {
    Clear();
  }
  void Clear()
  ...
  void deserialize(DataStream& ds)
  {
    ...
    //{
    //  throw protogen::framework::IncompatibleVersionException("GetDeliveriesListResp");
    //}
    //seqNum=ds.readInt32();
    while(!endOfMessage)
    {
      ...
      switch(tag)
      {
        ...
        default:
          ...
          //{
          //  throw protogen::framework::UnexpectedTag("GetDeliveriesListResp",tag);
          //}
