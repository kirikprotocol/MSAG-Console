#ifndef __GENERATED_MESSAGE_EYELINE_INFORMER_DCP_MESSAGES_GETDELIVERIESLISTNEXT_HPP__
#define __GENERATED_MESSAGE_EYELINE_INFORMER_DCP_MESSAGES_GETDELIVERIESLISTNEXT_HPP__
...
#ident "@(#) GetDeliveriesListNext version 1.0"
...
class GetDeliveriesListNext{
public:
  GetDeliveriesListNext()
  {
    Clear();
  }
  void Clear()
  ...
  void deserialize(DataStream& ds)
  {
    ...
    //{
    //  throw protogen::framework::IncompatibleVersionException("GetDeliveriesListNext");
    //}
    //seqNum=ds.readInt32();
    while(!endOfMessage)
    {
      ...
      switch(tag)
      {
        ...
        default:
          ...
          //{
          //  throw protogen::framework::UnexpectedTag("GetDeliveriesListNext",tag);
          //}
