#ifndef __GENERATED_MESSAGE_EYELINE_INFORMER_DCP_MESSAGES_USERAUTH_HPP__
#define __GENERATED_MESSAGE_EYELINE_INFORMER_DCP_MESSAGES_USERAUTH_HPP__
...
public:
  ...
  void serialize(DataStream& ds)const
  {
    if(!userIdFlag)
    {
      throw eyeline::protogen::framework::MandatoryFieldMissingException("userId");
    }
    if(!passwordFlag)
    {
  ...
  void deserialize(DataStream& ds)
  {
    ...
    //{
    //  throw protogen::framework::IncompatibleVersionException("UserAuth");
    //}
    //seqNum=ds.readInt32();
    while(!endOfMessage)
    {
      ...
      switch(tag)
      {
        ...
        default:
          ...
          //{
          //  throw protogen::framework::UnexpectedTag("UserAuth",tag);
          //}
...
protected:
  ...
  static const int32_t passwordTag=2;
