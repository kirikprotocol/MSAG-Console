...
static asn_TYPE_tag2member_t asn_MAP_fCIBCCCAMELsequence1_2_tag2el[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* freeFormatData at 695 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* appendFreeFormatData at 698 */
};
...
static asn_TYPE_tag2member_t asn_MAP_CAMEL_FCISMSBillingChargingCharacteristics_1_tag2el[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* fCIBCCCAMELsequence1 at 697 */
};
