...
int
TimerValue_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
TimerValue_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
TimerValue_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	TimerValue_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
TimerValue_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
TimerValue_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TimerValue_encode_der(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TimerValue_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_TimerValue = {
	"TimerValue",
	"TimerValue",
	TimerValue_free,
	TimerValue_print,
	...
	sizeof(asn_DEF_TimerValue_1_tags)
		/sizeof(asn_DEF_TimerValue_1_tags[0]), /* 1 */
	asn_DEF_TimerValue_1_tags,	/* Same as above */
	sizeof(asn_DEF_TimerValue_1_tags)
		/sizeof(asn_DEF_TimerValue_1_tags[0]), /* 1 */
	0, 0,	/* No members */
	0	/* No specifics */
