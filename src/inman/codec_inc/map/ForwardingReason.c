...
#endif /* ASN1_XER_NOT_USED */
static asn_INTEGER_enum_map_t asn_MAP_ForwardingReason_1_value2enum[] = {
	{ 0,	12,	"notReachable" },
	{ 1,	4,	"busy" },
	{ 2,	7,	"noReply" }
};
static unsigned int asn_MAP_ForwardingReason_1_enum2value[] = {
	1,	/* busy(1) */
	2,	/* noReply(2) */
	0	/* notReachable(0) */
};
static asn_INTEGER_specifics_t asn_SPC_ForwardingReason_1_specs = {
	asn_MAP_ForwardingReason_1_value2enum,	/* "tag" => N; sorted by tag */
	asn_MAP_ForwardingReason_1_enum2value,	/* N => "tag"; sorted by N */
	3,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1	/* Strict enumeration */
};
static ber_tlv_tag_t asn_DEF_ForwardingReason_1_tags[] = {
...
asn_TYPE_descriptor_t asn_DEF_ForwardingReason = {
	...
	asn_DEF_ForwardingReason_1_tags,
	sizeof(asn_DEF_ForwardingReason_1_tags)
		/sizeof(asn_DEF_ForwardingReason_1_tags[0]), /* 1 */
	asn_DEF_ForwardingReason_1_tags,	/* Same as above */
	sizeof(asn_DEF_ForwardingReason_1_tags)
		/sizeof(asn_DEF_ForwardingReason_1_tags[0]), /* 1 */
	0, 0,	/* Defined elsewhere */
	&asn_SPC_ForwardingReason_1_specs	/* Additional specs */
};
