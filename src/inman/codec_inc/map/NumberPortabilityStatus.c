...
#endif /* ASN1_XER_NOT_USED */
static asn_INTEGER_enum_map_t asn_MAP_NumberPortabilityStatus_1_value2enum[] = {
...
static unsigned int asn_MAP_NumberPortabilityStatus_1_enum2value[] = {
...
static asn_INTEGER_specifics_t asn_SPC_NumberPortabilityStatus_1_specs = {
	asn_MAP_NumberPortabilityStatus_1_value2enum,	/* "tag" => N; sorted by tag */
	asn_MAP_NumberPortabilityStatus_1_enum2value,	/* N => "tag"; sorted by N */
	5,	/* Number of elements in the maps */
	1,	/* Enumeration is extensible */
	1	/* Strict enumeration */
};
static ber_tlv_tag_t asn_DEF_NumberPortabilityStatus_1_tags[] = {
...
asn_TYPE_descriptor_t asn_DEF_NumberPortabilityStatus = {
	...
	asn_DEF_NumberPortabilityStatus_1_tags,
	sizeof(asn_DEF_NumberPortabilityStatus_1_tags)
		/sizeof(asn_DEF_NumberPortabilityStatus_1_tags[0]), /* 1 */
	asn_DEF_NumberPortabilityStatus_1_tags,	/* Same as above */
	sizeof(asn_DEF_NumberPortabilityStatus_1_tags)
		/sizeof(asn_DEF_NumberPortabilityStatus_1_tags[0]), /* 1 */
	0, 0,	/* Defined elsewhere */
	&asn_SPC_NumberPortabilityStatus_1_specs	/* Additional specs */
};
