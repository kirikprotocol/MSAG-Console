...
#endif /* ASN1_XER_NOT_USED */
static asn_INTEGER_enum_map_t asn_MAP_T_BcsmTriggerDetectionPoint_1_value2enum[] = {
	{ 12,	21,	"termAttemptAuthorized" },
	{ 13,	5,	"tBusy" },
	{ 14,	9,	"tNoAnswer" }
	/* This list is extensible */
};
static unsigned int asn_MAP_T_BcsmTriggerDetectionPoint_1_enum2value[] = {
	1,	/* tBusy(13) */
	2,	/* tNoAnswer(14) */
	0	/* termAttemptAuthorized(12) */
	/* This list is extensible */
};
static asn_INTEGER_specifics_t asn_SPC_T_BcsmTriggerDetectionPoint_1_specs = {
	asn_MAP_T_BcsmTriggerDetectionPoint_1_value2enum,	/* "tag" => N; sorted by tag */
	asn_MAP_T_BcsmTriggerDetectionPoint_1_enum2value,	/* N => "tag"; sorted by N */
	3,	/* Number of elements in the maps */
	1,	/* Enumeration is extensible */
	1	/* Strict enumeration */
};
static ber_tlv_tag_t asn_DEF_T_BcsmTriggerDetectionPoint_1_tags[] = {
...
asn_TYPE_descriptor_t asn_DEF_T_BcsmTriggerDetectionPoint = {
	...
	asn_DEF_T_BcsmTriggerDetectionPoint_1_tags,
	sizeof(asn_DEF_T_BcsmTriggerDetectionPoint_1_tags)
		/sizeof(asn_DEF_T_BcsmTriggerDetectionPoint_1_tags[0]), /* 1 */
	asn_DEF_T_BcsmTriggerDetectionPoint_1_tags,	/* Same as above */
	sizeof(asn_DEF_T_BcsmTriggerDetectionPoint_1_tags)
		/sizeof(asn_DEF_T_BcsmTriggerDetectionPoint_1_tags[0]), /* 1 */
	0, 0,	/* Defined elsewhere */
	&asn_SPC_T_BcsmTriggerDetectionPoint_1_specs	/* Additional specs */
};
