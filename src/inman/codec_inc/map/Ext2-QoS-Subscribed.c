...
#endif /* ASN1_XER_NOT_USED */
static ber_tlv_tag_t asn_DEF_Ext2_QoS_Subscribed_1_tags[] = {
...
asn_TYPE_descriptor_t asn_DEF_Ext2_QoS_Subscribed = {
	...
	asn_DEF_Ext2_QoS_Subscribed_1_tags,
	sizeof(asn_DEF_Ext2_QoS_Subscribed_1_tags)
		/sizeof(asn_DEF_Ext2_QoS_Subscribed_1_tags[0]), /* 1 */
	asn_DEF_Ext2_QoS_Subscribed_1_tags,	/* Same as above */
	sizeof(asn_DEF_Ext2_QoS_Subscribed_1_tags)
		/sizeof(asn_DEF_Ext2_QoS_Subscribed_1_tags[0]), /* 1 */
	0, 0,	/* No members */
	0	/* No specifics */
