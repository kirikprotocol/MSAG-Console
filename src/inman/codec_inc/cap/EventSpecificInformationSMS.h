...
typedef struct o_smsFailureSpecificInfo_s {
...
typedef struct o_smsSubmissionSpecificInfo_s {
	/*
	 * This type is extensible,
	 * possible extensions are below.
	 */
...
typedef struct t_smsFailureSpecificInfo_s {
...
typedef struct t_smsDeliverySpecificInfo_s {
	/*
	 * This type is extensible,
	 * possible extensions are below.
	 */
...
typedef struct EventSpecificInformationSMS {
	...
	union EventSpecificInformationSMS_u {
		struct o_smsFailureSpecificInfo_s	 o_smsFailureSpecificInfo;
		struct o_smsSubmissionSpecificInfo_s o_smsSubmissionSpecificInfo;
		struct t_smsFailureSpecificInfo_s	 t_smsFailureSpecificInfo;
		struct t_smsDeliverySpecificInfo_s   t_smsDeliverySpecificInfo;
	} choice;
