...
static asn_TYPE_tag2member_t asn_MAP_T_BCSM_CAMEL_TDP_Criteria_1_tag2el[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (10 << 2)), 0, 0, 0 }, /* t-BCSM-TriggerDetectionPoint at 530 */
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 1, 0, 0 }, /* basicServiceCriteria at 531 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 2, 0, 0 } /* t-CauseValueCriteria at 532 */
};
