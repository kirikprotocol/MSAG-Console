...
std::string getRedirectionInfoDescription(EINSS7_I97_REDIRECTIONINFO_T* redirectionInfo)
{
  ...
  std::string res = "Redirection indicator=";
...
std::string getAutoCongLevelDescription(UCHAR_T* autoCongestLevel)
{
  ...
  std::string res = "Auto Congestion level=(";
...
{
  std::string res = "Response indicator=(";
...
{
  std::string res = "Source indicator=(";
  switch(sourceInd)
  {
...
{
  if (!cause_sp) return "";
  std::string res = "Cause indicator=(";
