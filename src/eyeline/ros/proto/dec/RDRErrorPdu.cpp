...
{
  asn1::ber::DecoderOfSequence_T<3>::setField(0, asn1::_uniTag().INTEGER, asn1::ber::EDAlternative::altMANDATORY);
  asn1::ber::DecoderOfSequence_T<3>::setField(1, asn1::_uniTag().INTEGER, asn1::ber::EDAlternative::altMANDATORY);
