#ifndef __GENERATED_MESSAGE_EYELINE_CLUSTERCONTROLLER_PROTOCOL_MESSAGES_APPLYMAPLIMITSRESP_HPP__
#define __GENERATED_MESSAGE_EYELINE_CLUSTERCONTROLLER_PROTOCOL_MESSAGES_APPLYMAPLIMITSRESP_HPP__
...
#ident "@(#) ApplyMapLimitsResp version 1.0"
...
public:
  ...
  void deserialize(DataStream& ds)
  {
    ...
    //{
    //  throw protogen::framework::IncompatibleVersionException("ApplyMapLimitsResp");
    //}
    //seqNum=ds.readInt32();
    while(!endOfMessage)
    {
      ...
      switch(tag)
      {
        ...
        default:
          ...
          //{
          //  throw protogen::framework::UnexpectedTag("ApplyMapLimitsResp",tag);
          //}
