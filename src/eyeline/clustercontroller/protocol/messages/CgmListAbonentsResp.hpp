#ifndef __GENERATED_MESSAGE_EYELINE_CLUSTERCONTROLLER_PROTOCOL_MESSAGES_CGMLISTABONENTSRESP_HPP__
#define __GENERATED_MESSAGE_EYELINE_CLUSTERCONTROLLER_PROTOCOL_MESSAGES_CGMLISTABONENTSRESP_HPP__
...
#ident "@(#) CgmListAbonentsResp version 1.0"
    ...
    while(!endOfMessage)
    {
      ...
      switch(tag)
      {
        ...
        default:
          ...
          //{
          //  throw protogen::framework::UnexpectedTag("CgmListAbonentsResp",tag);
          //}
