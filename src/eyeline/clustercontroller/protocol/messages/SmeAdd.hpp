#ifndef __GENERATED_MESSAGE_EYELINE_CLUSTERCONTROLLER_PROTOCOL_MESSAGES_SMEADD_HPP__
#define __GENERATED_MESSAGE_EYELINE_CLUSTERCONTROLLER_PROTOCOL_MESSAGES_SMEADD_HPP__
    ...
    while(!endOfMessage)
    {
      ...
      switch(tag)
      {
        ...
        default:
          ...
          //{
          //  throw protogen::framework::UnexpectedTag("SmeAdd",tag);
          //}
