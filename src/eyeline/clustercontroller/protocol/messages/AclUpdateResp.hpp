#ifndef __GENERATED_MESSAGE_EYELINE_CLUSTERCONTROLLER_PROTOCOL_MESSAGES_ACLUPDATERESP_HPP__
#define __GENERATED_MESSAGE_EYELINE_CLUSTERCONTROLLER_PROTOCOL_MESSAGES_ACLUPDATERESP_HPP__
...
#ident "@(#) AclUpdateResp version 1.0"
...
public:
  ...
  void deserialize(DataStream& ds)
  {
    ...
    //{
    //  throw protogen::framework::IncompatibleVersionException("AclUpdateResp");
    //}
    //seqNum=ds.readInt32();
    while(!endOfMessage)
    {
      ...
      switch(tag)
      {
        ...
        default:
          ...
          //{
          //  throw protogen::framework::UnexpectedTag("AclUpdateResp",tag);
          //}
