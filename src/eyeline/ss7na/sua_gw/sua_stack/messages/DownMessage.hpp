#ifndef __EYELINE_SS7NA_SUAGW_SUASTACK_MESSAGES_DOWNMESSAGE_HPP__
# define __EYELINE_SS7NA_SUAGW_SUASTACK_MESSAGES_DOWNMESSAGE_HPP__
...
public:
  ...
  virtual const char* getMsgCodeTextDescription() const { return "ASP DOWN"; }
