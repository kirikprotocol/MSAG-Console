#ifndef __EYELINE_SS7NA_SUAGW_SUASTACK_MESSAGES_DAVAMESSAGE_HPP__
# define __EYELINE_SS7NA_SUAGW_SUASTACK_MESSAGES_DAVAMESSAGE_HPP__
...
class DAVAMessage : public common::AdaptationLayer_Message {
public:
  DAVAMessage ()
  ...
  virtual const char* getMsgCodeTextDescription() const { return "DAVA"; }
