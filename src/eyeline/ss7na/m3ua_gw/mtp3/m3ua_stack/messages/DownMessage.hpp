#ifndef __EYELINE_SS7NA_M3UAGW_MTP3_M3UASTACK_MESSAGES_DOWNMESSAGE_HPP__
# define __EYELINE_SS7NA_M3UAGW_MTP3_M3UASTACK_MESSAGES_DOWNMESSAGE_HPP__
...
class DownMessage : public common::AdaptationLayer_Message {
public:
  DownMessage ()
  ...
  virtual const char* getMsgCodeTextDescription() const { return "ASPDN"; }
...
private:
  ...
  static const uint32_t _MSG_CODE = 0x0302;
};
