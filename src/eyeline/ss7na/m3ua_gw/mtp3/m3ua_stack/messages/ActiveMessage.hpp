#ifndef __EYELINE_SS7NA_M3UAGW_MTP3_M3UASTACK_MESSAGES_ACTIVEMESSAGE_HPP__
# define __EYELINE_SS7NA_M3UAGW_MTP3_M3UASTACK_MESSAGES_ACTIVEMESSAGE_HPP__
...
public:
  ...
  virtual const char* getMsgCodeTextDescription() const { return "ASPAC"; }
