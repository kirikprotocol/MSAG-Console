#ifndef __EYELINE_SS7NA_M3UAGW_MTP3_M3UASTACK_MESSAGES_UPMESSAGE_HPP__
# define __EYELINE_SS7NA_M3UAGW_MTP3_M3UASTACK_MESSAGES_UPMESSAGE_HPP__
...
class UPMessage : public common::AdaptationLayer_Message {
public:
  UPMessage ()
  ...
  virtual const char* getMsgCodeTextDescription() const { return "ASPUP"; }

  void setAspIdentifier(const common::TLV_AspIdentifier& asp_id) { _aspId = asp_id; }
...
private:
  common::TLV_AspIdentifier _aspId;
