...
DUNAMessage::serialize(common::TP* result_buf) const
{
  ...
  if ( _affectedPointCodes.isSetValue() )
    ...
    throw smsc::util::Exception("DUNAMessage::serialize::: affectedPointCode is a mandatory field and wasn't set");
...
DUNAMessage::getNetworkAppearance() const
{
  if ( _networkAppearance.isSetValue() ) return _networkAppearance;
  else throw utilx::FieldNotSetException("DUNAMessage::getNetworkAppearance::: smi wasn't set");
}
