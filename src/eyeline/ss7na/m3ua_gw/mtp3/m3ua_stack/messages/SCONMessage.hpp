#ifndef __EYELINE_SS7NA_M3UAGW_MTP3_M3UASTACK_MESSAGES_SCONMESSAGE_HPP__
# define __EYELINE_SS7NA_M3UAGW_MTP3_M3UASTACK_MESSAGES_SCONMESSAGE_HPP__
...
public:
  ...
  void setConcernedDestination(const TLV_ConcernedDestination& concerned_dest) { _concernedDestination = concerned_dest; }
  const TLV_ConcernedDestination& getConcernedDestination() const;

  void setCongestionIndication(const TLV_CongestionIndication& congestion_ind) { _congestionIndication = congestion_ind; }
  const TLV_CongestionIndication& getCongestionIndication() const;
...
private:
  ...
  TLV_ConcernedDestination _concernedDestination;
  TLV_CongestionIndication _congestionIndication;
