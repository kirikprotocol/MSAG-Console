#ifndef __EYELINE_SS7NA_M3UAGW_MTP3_M3UASTACK_MESSAGES_UPACKMESSAGE_HPP__
# define __EYELINE_SS7NA_M3UAGW_MTP3_M3UASTACK_MESSAGES_UPACKMESSAGE_HPP__
...
class UPAckMessage : public common::AdaptationLayer_Message {
public:
  UPAckMessage ()
  ...
  virtual const char* getMsgCodeTextDescription() const { return "ASPUP ACK"; }
