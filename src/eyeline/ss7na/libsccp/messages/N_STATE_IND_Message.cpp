...
size_t
N_STATE_IND_Message::serialize(common::TP* result_buf) const
{
  ...
  offset = common::addField(result_buf, offset, _userStatus);
...
size_t
N_STATE_IND_Message::serialize(uint8_t* result_buf, size_t result_buf_max_sz) const
{
...
size_t
N_STATE_IND_Message::deserialize(const common::TP& packet_buf)
{
  ...
  offset = common::extractField(packet_buf, offset, &_userStatus);
...
size_t
N_STATE_IND_Message::deserialize(const uint8_t* packet_buf, size_t packet_buf_sz)
{
...
void
N_STATE_IND_Message::setSubsystemMultiplicityInd(uint8_t subsystem_mult_ind)
{
