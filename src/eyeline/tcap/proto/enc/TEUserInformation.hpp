...
class TEUserInformation : public
  asn1::ber::EncoderOfSeqOfLinked_T<asn1::ASExternal, asn1::ber::EncoderOfExternal,
                                  _TMsgDfltNumOfUserInfos> {
public:
  static const asn1::ASTagging _typeTags;

  explicit TEUserInformation(asn1::TransferSyntax::Rule_e use_rule = asn1::TransferSyntax::ruleDER)
    : asn1::ber::EncoderOfSeqOfLinked_T<asn1::ASExternal, asn1::ber::EncoderOfExternal,
                                      _TMsgDfltNumOfUserInfos>(_typeTags, use_rule)
  { }
  ~TEUserInformation()
  { }

  //void setValue(const tcap::TDlgUserInfoPtrList & ui_list) /*throw(std::exception)*/;
};
