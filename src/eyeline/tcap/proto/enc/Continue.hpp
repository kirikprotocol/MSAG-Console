#ifndef __EYELINE_TCAP_PROTO_CONTINUE_HPP__
# ident "@(#)$Id$"
# define __EYELINE_TCAP_PROTO_CONTINUE_HPP__
...
class Continue {
public:
  explicit Continue(TransactionId transaction_id)
