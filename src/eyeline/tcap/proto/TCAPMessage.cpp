...
ASTypeAC::ENCResult
  TCAPMessage::Encode(BITBuffer & use_buf, EncodingRule use_rule/* = ruleDER*/)
...
ASTypeAC::DECResult
  TCAPMessage::Decode(const BITBuffer & use_buf, EncodingRule use_rule/* = ruleDER*/)
  /*throw ASN1CodecError*/
{
  //TODO:
...
//NOTE: in case of decMoreInput, stores decoding context 
ASTypeAC::DECResult
  TCAPMessage::DeferredDecode(const BITBuffer & use_buf, EncodingRule use_rule/* = ruleDER*/)
  /*throw ASN1CodecError*/
{
  //TODO:
  return ASTypeAC::DECResult();
