...
#include "eyeline/asn1/BER/tests/dec/MDSeqType4.hpp"
...
const ASTag MDSeqType4::_tag_B(ASTag::tagContextSpecific, 3);
const ASTag MDSeqType4::_tag_C(ASTag::tagContextSpecific, 4);
