...
public:
  ...
  explicit EncoderOfSequence_T(TransferSyntax::Rule_e use_rule = TransferSyntax::ruleDER)
    : EncoderOfStructure_T<_NumFieldsTArg>(asn1::_uniTagging().SEQOF, use_rule)
  { }
  //Constructor for tagged SEQUENCE type
  EncoderOfSequence_T(const ASTag & use_tag, ASTagging::Environment_e tag_env,
                    TransferSyntax::Rule_e use_rule = TransferSyntax::ruleDER)
    : EncoderOfStructure_T<_NumFieldsTArg>(use_tag, tag_env, asn1::_uniTagging().SEQOF, use_rule)
  { }
