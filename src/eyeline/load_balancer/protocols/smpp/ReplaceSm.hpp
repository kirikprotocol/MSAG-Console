#ifndef __EYELINE_LOADBALANCER_PROTOCOLS_SMPP_REPLACESM_HPP__
# define __EYELINE_LOADBALANCER_PROTOCOLS_SMPP_REPLACESM_HPP__
...
class ReplaceSm : public SMPPMessage {
public:
  ReplaceSm();
  ...
  static const uint32_t _MSGCODE = 0x00000007;
