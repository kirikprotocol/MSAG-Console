#ifndef __EYELINE_LOADBALANCER_PROTOCOLS_SMPP_SUBMITMULTI_HPP__
# define __EYELINE_LOADBALANCER_PROTOCOLS_SMPP_SUBMITMULTI_HPP__
...
class SubmitMulti : public SMPPMessage {
public:
  SubmitMulti();
  ...
  static const uint32_t _MSGCODE = 0x00000021;
...
private:
  ...
  enum { DST_FLG_SME_ADDRESS = 1, DST_FLG_DISTRIB_LIST_NAME = 2};
};
