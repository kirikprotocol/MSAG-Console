...
public:
  ...
  Packet* receive(corex::io::InputStream* iStream);
  virtual Packet* prepareToSend(const Message& msg);
protected:
  virtual void readNextPartOfPacketHeader(corex::io::InputStream* iStream) = 0;
  virtual void readNextPartOfPacketBody(corex::io::InputStream* iStream) = 0;
  virtual void readNextPartOfPacketTailer(corex::io::InputStream* iStream) = 0;
