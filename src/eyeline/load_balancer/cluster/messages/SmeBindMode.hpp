#ifndef __GENERATED_ENUM_EYELINE_LOAD_BALANCER_CLUSTER_MESSAGES_SMEBINDMODE__
#define __GENERATED_ENUM_EYELINE_LOAD_BALANCER_CLUSTER_MESSAGES_SMEBINDMODE__
