...
communication::sua_messages::TLV_RoutingContext
...
void
RCRegistry::insert(const communication::LinkId& linkId, const communication::sua_messages::TLV_RoutingContext& rc)
{
  smsc::core::synchronization::MutexGuard lockGuard(_lock);
