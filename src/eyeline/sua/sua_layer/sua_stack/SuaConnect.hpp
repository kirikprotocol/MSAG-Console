#ifndef __EYELINE_SUA_SUALAYER_SUASTACK_SUACONNECT_HPP__
# define __EYELINE_SUA_SUALAYER_SUASTACK_SUACONNECT_HPP__
...
private:
  ...
  uint8_t _header[communication::sua_messages::SUAMessage::HEADER_SIZE];
