...
void
AspMaintenanceMessageHandlers::handle(const communication::sua_messages::ActiveMessage& message, const communication::LinkId& linkId)
{
...
void
AspMaintenanceMessageHandlers::handle(const communication::sua_messages::ActiveAckMessage& message, const communication::LinkId& linkId)
{
...
void
AspMaintenanceMessageHandlers::handle(const communication::sua_messages::InactiveMessage& message, const communication::LinkId& linkId)
{
...
void
AspMaintenanceMessageHandlers::handle(const communication::sua_messages::InactiveAckMessage& message, const communication::LinkId& linkId)
{
...
void
AspMaintenanceMessageHandlers::handle(const communication::sua_messages::UPMessage& message, const communication::LinkId& linkId)
{
...
void
AspMaintenanceMessageHandlers::handle(const communication::sua_messages::UPAckMessage& message, const communication::LinkId& linkId)
{
  ...
  if ( _trafficMode != io_dispatcher::LinkSet::UNSPECIFIED )
    activeMessage.setTrafficModyType(communication::sua_messages::TLV_TrafficModeType(_trafficMode));

  _cMgr.send(linkId, activeMessage);
}

void
AspMaintenanceMessageHandlers::handle(const communication::sua_messages::DownMessage& message, const communication::LinkId& linkId)
{
...
void
AspMaintenanceMessageHandlers::handle(const communication::sua_messages::DownAckMessage& message, const communication::LinkId& linkId)
{
