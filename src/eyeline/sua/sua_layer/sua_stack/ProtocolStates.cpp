...
SUA_State_ASPDown::SUA_State_ASPDown()
  : _upMessageCode (communication::sua_messages::UPMessage().getMsgCode()),
...
SUA_Incoming_ManagmentMessages_Permitted::SUA_Incoming_ManagmentMessages_Permitted()
  : _notifyMessageCode(communication::sua_messages::NotifyMessage().getMsgCode()),
    _errorMessageCode(communication::sua_messages::ErrorMessage().getMsgCode()) {}
...
SUA_State_ASPDownPending::SUA_State_ASPDownPending()
  : _downAckMessageCode(communication::sua_messages::DownAckMessage().getMsgCode()),
    _sctpConnectReleasedInd_MessageCode(SctpReleaseInd().getIndicationTypeValue()) {}
...
SUA_State_ASPInactivePending::SUA_State_ASPInactivePending()
  : _upMessageAckCode(communication::sua_messages::UPAckMessage().getMsgCode()),
    _sctpConnectReleasedInd_MessageCode(SctpReleaseInd().getIndicationTypeValue()) {}
...
SUA_State_ASPInactive::SUA_State_ASPInactive()
  : _activeMessageCode(communication::sua_messages::ActiveMessage().getMsgCode()),
    _downMessageCode(communication::sua_messages::DownMessage().getMsgCode()),
    _sctpConnectReleasedInd_MessageCode(SctpReleaseInd().getIndicationTypeValue())
{}
...
SUA_State_ASPActivePending::SUA_State_ASPActivePending()
  : _activeAckMessageCode(communication::sua_messages::ActiveAckMessage().getMsgCode()),
    _sctpConnectReleasedInd_MessageCode(SctpReleaseInd().getIndicationTypeValue()),
    _downMessageCode(communication::sua_messages::DownMessage().getMsgCode()) {}
...
SUA_State_ASPActive::SUA_State_ASPActive()
  : _inactiveMessageCode(communication::sua_messages::InactiveMessage().getMsgCode()),
    _downMessageCode(communication::sua_messages::DownMessage().getMsgCode()),
    _sctpConnectReleasedInd_MessageCode(SctpReleaseInd().getIndicationTypeValue()) {}
...
SUA_State_ASPActiveShutdown::SUA_State_ASPActiveShutdown()
  : _inactiveAckMessageCode(communication::sua_messages::InactiveAckMessage().getMsgCode()),
    _sctpConnectReleasedInd_MessageCode(SctpReleaseInd().getIndicationTypeValue()) {}
