#ifndef __EYELINE_SUA_COMMUNICATION_SUAMESSAGES_DAUDMESSAGE_HPP__
# define __EYELINE_SUA_COMMUNICATION_SUAMESSAGES_DAUDMESSAGE_HPP__
...
class DAUDMessage : public SUAMessage {
public:
  DAUDMessage();
