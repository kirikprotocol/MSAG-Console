#ifndef __EYELINE_SUA_COMMUNICATION_SUAMESSAGES_DOWNACKMESSAGE_HPP__
# define __EYELINE_SUA_COMMUNICATION_SUAMESSAGES_DOWNACKMESSAGE_HPP__
...
class DownAckMessage : public SUAMessage {
public:
  DownAckMessage();
