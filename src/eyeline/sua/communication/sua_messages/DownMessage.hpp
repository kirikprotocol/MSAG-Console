#ifndef __EYELINE_SUA_COMMUNICATION_SUAMESSAGES_DOWNMESSAGE_HPP__
# define __EYELINE_SUA_COMMUNICATION_SUAMESSAGES_DOWNMESSAGE_HPP__
...
class DownMessage : public SUAMessage {
public:
  DownMessage();
