 ...
 */
    ...
    if ((NULL == (* smeStatSystemId_val_ptr_ptr )) ||
        ((* smeStatSystemId_val_ptr_len_ptr ) <
         (rowreq_ctx->data.smeStatSystemId_len* sizeof(rowreq_ctx->data.smeStatSystemId[0])))) {
        /*
         * allocate space for smeStatSystemId data
         */
        (* smeStatSystemId_val_ptr_ptr ) = malloc(rowreq_ctx->data.smeStatSystemId_len* sizeof(rowreq_ctx->data.smeStatSystemId[0]));
        if(NULL == (* smeStatSystemId_val_ptr_ptr )) {
...
/*---------------------------------------------------------------------
 * SIBINCO-SMSC-MIB::smeStatEntry.smeStatRetried
 * smeStatRetried is subid 8 of smeStatEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.4.1.26757.1.10.1.8
 * Description:
SME Counter Temporal Errors
 *
 * Attributes:
 ...
 */
/**
 * Extract the current value of the smeStatRetried data.
 *
 * Set a value using the data context for the row.
 *
 * @param rowreq_ctx
 *        Pointer to the row request context.
 * @param smeStatRetried_val_ptr
 *        Pointer to storage for a U64 variable
 *
 * @retval MFD_SUCCESS         : success
 * @retval MFD_SKIP            : skip this node (no value for now)
