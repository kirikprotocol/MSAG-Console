...
const oid smeStatTable_oid[] = { SMESTATTABLE_OID };
const int smeStatTable_oid_size = OID_LENGTH(smeStatTable_oid);

    smeStatTable_registration  smeStatTable_user_context;
...
{
    smeStatTable_registration * user_context;
    u_long flags;
 ...
 */
void
shutdown_table_smeStatTable(void)
{
    /*
 ...
 */
int
smeStatTable_rowreq_ctx_init(smeStatTable_rowreq_ctx *rowreq_ctx,
                           void *user_init_ctx)
{
    ...
    /*
     * TODO:210:o: |-> Perform extra smeStatTable rowreq initialization. (eg DEFVALS)
     */
...
void smeStatTable_rowreq_ctx_cleanup(smeStatTable_rowreq_ctx *rowreq_ctx)
{
    ...
    /*
     * TODO:211:o: |-> Perform extra smeStatTable rowreq cleanup.
     */
 ...
 */
int
smeStatTable_pre_request(smeStatTable_registration * user_context)
{
 ...
 */
int
smeStatTable_post_request(smeStatTable_registration * user_context, int rc)
{
