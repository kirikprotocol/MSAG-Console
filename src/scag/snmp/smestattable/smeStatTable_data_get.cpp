 ...
 */
/**
 * Extract the current value of the smeStatRecieptOk data.
 *
 * Set a value using the data context for the row.
 *
 * @param rowreq_ctx
 *        Pointer to the row request context.
 * @param smeStatRecieptOk_val_ptr
 *        Pointer to storage for a U64 variable
 *
 * @retval MFD_SUCCESS         : success
 * @retval MFD_SKIP            : skip this node (no value for now)
 ...
 */
int
smeStatRecieptOk_get( smeStatTable_rowreq_ctx *rowreq_ctx, U64 * smeStatRecieptOk_val_ptr )
{
   /** we should have a non-NULL pointer */
   netsnmp_assert( NULL != smeStatRecieptOk_val_ptr );

/*
 * TODO:231:o: |-> copy smeStatRecieptOk data.
 * get (* smeStatRecieptOk_val_ptr ).low and (* smeStatRecieptOk_val_ptr ).high from rowreq_ctx->data
 */
    (* smeStatRecieptOk_val_ptr ).high = rowreq_ctx->data.smeStatRecieptOk.high;
    (* smeStatRecieptOk_val_ptr ).low = rowreq_ctx->data.smeStatRecieptOk.low;


    return MFD_SUCCESS;
} /* smeStatRecieptOk_get */
 ...
 */
/**
 * Extract the current value of the smeStatRecieptFailed data.
 *
 * Set a value using the data context for the row.
 *
 * @param rowreq_ctx
 *        Pointer to the row request context.
 * @param smeStatRecieptFailed_val_ptr
 *        Pointer to storage for a U64 variable
 *
 * @retval MFD_SUCCESS         : success
 * @retval MFD_SKIP            : skip this node (no value for now)
 ...
 */
int
smeStatRecieptFailed_get( smeStatTable_rowreq_ctx *rowreq_ctx, U64 * smeStatRecieptFailed_val_ptr )
{
   /** we should have a non-NULL pointer */
   netsnmp_assert( NULL != smeStatRecieptFailed_val_ptr );

/*
 * TODO:231:o: |-> copy smeStatRecieptFailed data.
 * get (* smeStatRecieptFailed_val_ptr ).low and (* smeStatRecieptFailed_val_ptr ).high from rowreq_ctx->data
 */
    (* smeStatRecieptFailed_val_ptr ).high = rowreq_ctx->data.smeStatRecieptFailed.high;
    (* smeStatRecieptFailed_val_ptr ).low = rowreq_ctx->data.smeStatRecieptFailed.low;


    return MFD_SUCCESS;
} /* smeStatRecieptFailed_get */
