...
------------------------------------------------------------------------
  ...
  the msagCounterTable table.  The agent will start by looking for the right
  ...
  file defaults/table-msagCounterTable.m2d, and then re-running mib2c.
    ...
    in the msagCounterTable.h header.
    ...
    will be generated:
      ...
      msagCounterTable_allocate_data
      msagCounterTable_release_data
 ...
 Index(es) for the msagCounterTable table
  ------------------------------------------------------------
  The index(es) for the msagCounterTable table are:
...
************************************************************************
msagCounterTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the msagCounterTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: msagCounterTable_data_access.[c|h]
------------------------------------------------------------------------
  The msagCounterTable_data_access file contains the interface to your data in
...
File: msagCounterTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : msagCounterName_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : msagCounterValue_get



File: msagCounterTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      msagCounterTable table.

      Conversely, the examples below may not include some functions that
      were generated for the msagCounterTable table.

To watch the flow of the msagCounterTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        msagCounterTable
        verbose:msagCounterTable
        internal:msagCounterTable

e.g.
        snmpd -f -Le -DmsagCounterTable,verbose:msagCounterTable,internal:msagCounterTable
...
/*---------------------------------------------------------------------
 * EYELINE-MSAG-MIB::msagCounterEntry.msagCounterIndex
 * msagCounterIndex is subid 1 of msagCounterEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.4.1.26757.2.4.1.1
 * Description:
MSAG Counter Index
 *
 * Attributes:
