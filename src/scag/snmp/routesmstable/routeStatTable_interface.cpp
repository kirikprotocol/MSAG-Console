...
void _routeStatTable_initialize_interface(routeStatTable_registration_ptr reg_ptr,  u_long flags)
{
  ...
  /*  Define the minimum and maximum accessible columns.  This
      optimizes retrieval. */
  tbl_info->min_column = ROUTESMSTABLE_MIN_COL;
  tbl_info->max_column = ROUTESMSTABLE_MAX_COL;
   ...
   */
  DEBUGMSGTL(("routeStatTable:init_routeStatTable", "Registering routeSmsTable as a mibs-for-dummies table.\n"));
  handler = netsnmp_baby_steps_access_multiplexer_get(access_multiplexer);
  reginfo = netsnmp_handler_registration_create("routeSmsTable", handler,
                                                routeStatTable_oid,
  ...
  snmp_log(LOG_INFO,"register table routeSmsTable, success\n");
  smsc_log_debug(log, "register table routeSmsTable, success");
