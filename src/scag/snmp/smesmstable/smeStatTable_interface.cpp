...
void _smeStatTable_initialize_interface(smeStatTable_registration_ptr reg_ptr,  u_long flags)
{
   ...
   */
  DEBUGMSGTL(("smeStatTable:init_smeStatTable", "Registering smeSmsTable as a mibs-for-dummies table.\n"));
  handler = netsnmp_baby_steps_access_multiplexer_get(access_multiplexer);
//1
  reginfo = netsnmp_handler_registration_create("smeSmsTable", handler,
                                                smeStatTable_oid,
  ...
  snmp_log(LOG_INFO,"register table smeSmsTable, success\n");
  smsc_log_debug(log, "register table smeSmsTable, success");
