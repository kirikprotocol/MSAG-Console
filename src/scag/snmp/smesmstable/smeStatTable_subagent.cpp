...
{
  log = smsc::logger::Logger::getInstance("snmp.ssms");
  smsc_log_debug(log, "SmeSmsTableSubagent::Register");
  ...
  init_smeStatTable();
  init_snmp("smeSmsTable");
}

void SmeStatTableSubagent::Unregister()
{
  smsc_log_debug(log, "SmeSmsTableSubagent::Unregister");
  snmp_shutdown("smeSmsTable");
}
