...
public:
  ...
  void reloadTestRoutes(const RouteConfig& rcfg);
    RefferGuard<router::RouteManager> getTestRouterInstance();
...
//  std::string routerConfigFile;
  ...
  Mutex routerSwitchMutex;
    Reffer<router::RouteManager>* testRouter_;
...
RefferGuard<router::RouteManager> SmppManagerImpl::getTestRouterInstance()
{
    MutexGuard g(routerSwitchMutex);
    return RefferGuard<router::RouteManager>(testRouter_);
}
...
void SmppManagerImpl::ResetTestRouteManager(router::RouteManager* manager)
{
    ...
    testRouter_ = new Reffer<router::RouteManager>(manager);
}
