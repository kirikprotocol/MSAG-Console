...
begin with the msagCounterTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : msagCounterTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f msagCounterTable_Makefile


  File    : msagCounterTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   msagCounterTable-README-msagCounterTable.txt
...
------------------------------------------------------------------------
  ...
  File    : msagCounterTable_interface.c
