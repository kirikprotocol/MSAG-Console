...
public class BC_GET_RESP  extends BC_CMD 
{
    // static Logger logger = Logger.getLogger(BC_GET_RESP.class);
    ...
    public BC_GET_RESP(int seqNum, byte status , byte valueType , byte timePolicy , int finalDate , int lifeTime , String varName , int intValue , String stringValue , byte boolValue , int dateValue)
    {
        this.seqNum = seqNum;
        this.status = status;
    ...
    public void decode( IBufferReader reader ) throws java.io.IOException
    {
        ...
        while( true ) {
            ...
            default:
                ...
                // logger.warn( "unknown tagId: " + tag + " seqnum: " + seqNum + " msg: " + BC_GET_RESP.class.getName() );
            }
        }
        checkFields();
    }
