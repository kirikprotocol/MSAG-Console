...
protected:
    void checkFields() const throw (MandatoryFieldMissingException)
    {
        ...
        if (!statusFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "status", "PC_GET_RESP");
            throw MandatoryFieldMissingException(buf);
        }
        if (!valueTypeFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "valueType", "PC_GET_RESP");
            throw MandatoryFieldMissingException(buf);
        }
        if (!timePolicyFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "timePolicy", "PC_GET_RESP");
            throw MandatoryFieldMissingException(buf);
        }
        if (!finalDateFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "finalDate", "PC_GET_RESP");
            throw MandatoryFieldMissingException(buf);
        }
        if (!lifeTimeFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "lifeTime", "PC_GET_RESP");
            throw MandatoryFieldMissingException(buf);
        }
        if (!varNameFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "varName", "PC_GET_RESP");
            throw MandatoryFieldMissingException(buf);
        }
        ...
        if (!intValueFlag
            ...
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "intValue", "PC_GET_RESP");
            throw MandatoryFieldMissingException(buf);
        }
        if (!stringValueFlag
            && (valueType==2)
            ...
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "stringValue", "PC_GET_RESP");
            throw MandatoryFieldMissingException(buf);
        }
        if (!boolValueFlag
            && (valueType==3)
            ...
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "boolValue", "PC_GET_RESP");
            throw MandatoryFieldMissingException(buf);
        }
        if (!dateValueFlag
            && (valueType==4)
            ...
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "dateValue", "PC_GET_RESP");
            throw MandatoryFieldMissingException(buf);
        }
    }
