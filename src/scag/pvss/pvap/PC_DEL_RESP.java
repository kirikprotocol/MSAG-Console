...
public class PC_DEL_RESP  
{
    // static Logger logger = Logger.getLogger(PC_DEL_RESP.class);
    ...
    public PC_DEL_RESP(int seqNum, byte status)
    {
        this.seqNum = seqNum;
        this.status = status;
    ...
    public void decode( IBufferReader reader ) throws java.io.IOException
    {
        ...
        while( true ) {
            ...
            default:
                ...
                // logger.warn( "unknown tagId: " + tag + " seqnum: " + seqNum + " msg: " + PC_DEL_RESP.class.getName() );
            }
        }
        checkFields();
    }
