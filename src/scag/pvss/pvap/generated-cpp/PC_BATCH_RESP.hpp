...
// #include "scag/pvss/pvap/BatchCmdArray.h"
#include "scag/pvss/pvap/BatchResponseFiller.h"
...
protected:
    void checkFields() const throw (PvapException)
    {
        // using parent check
        if ( !data_->isValid() ) {
            throw MessageIsBrokenException(data_->isRequest(), "message PC_BATCH_RESP is broken: " + toString(), data_->getSeqNum() );
        }
    }
