...
public class BC_SET_RESP  extends BC_CMD 
{
    // static Logger logger = Logger.getLogger(BC_SET_RESP.class);
    ...
    public BC_SET_RESP(int seqNum, byte status)
    {
        this.seqNum = seqNum;
        this.status = status;
    ...
    public void decode( IBufferReader reader ) throws java.io.IOException
    {
        ...
        while( true ) {
            ...
            default:
                ...
                // logger.warn( "unknown tagId: " + tag + " seqnum: " + seqNum + " msg: " + BC_SET_RESP.class.getName() );
            }
        }
        checkFields();
    }
