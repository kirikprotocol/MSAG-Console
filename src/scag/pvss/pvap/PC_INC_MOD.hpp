...
protected:
    void checkFields() const throw (MandatoryFieldMissingException)
    {
        ...
        if (!profileTypeFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "profileType", "PC_INC_MOD");
            throw MandatoryFieldMissingException(buf);
        }
        if (!varNameFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "varName", "PC_INC_MOD");
            throw MandatoryFieldMissingException(buf);
        }
        if (!valueTypeFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "valueType", "PC_INC_MOD");
            throw MandatoryFieldMissingException(buf);
        }
        if (!timePolicyFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "timePolicy", "PC_INC_MOD");
            throw MandatoryFieldMissingException(buf);
        }
        if (!finalDateFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "finalDate", "PC_INC_MOD");
            throw MandatoryFieldMissingException(buf);
        }
        if (!lifeTimeFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "lifeTime", "PC_INC_MOD");
            throw MandatoryFieldMissingException(buf);
        }
        if (!intValueFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "intValue", "PC_INC_MOD");
            throw MandatoryFieldMissingException(buf);
        }
        if (!modValueFlag) {
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "modValue", "PC_INC_MOD");
            throw MandatoryFieldMissingException(buf);
        }
        ...
        if (!abonentKeyFlag
            ...
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "abonentKey", "PC_INC_MOD");
            throw MandatoryFieldMissingException(buf);
        }
        if (!profileKeyFlag
            && (profileType>1)
            ...
            char buf[256];
            snprintf( buf, sizeof(buf), "field=%s msg=%s", "profileKey", "PC_INC_MOD");
            throw MandatoryFieldMissingException(buf);
        }
    }
