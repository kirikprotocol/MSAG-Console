...
public:
    ...
    public:
         ...
         * @return              PVAP response generated by server logic for this request.
         * @throws Exception    May be thrown by server logic when it failed to process request.
         */
        virtual std::auto_ptr<Response> process(std::auto_ptr<Request>& request) throw(PvssException) = 0;
         ...
         */
        virtual void responseSent(std::auto_ptr<Response> response) = 0;
         ...
         */
        virtual void responseFail(std::auto_ptr<Response> response) = 0;
    };
