...
#ifndef SCAG_BILL_EWALLET_STREAM_COMMIT_HPP
#define SCAG_BILL_EWALLET_STREAM_COMMIT_HPP
...
public:
    ...
    int32_t getAgentId() const {
        if (!agentIdFlag) {
            throw Exception( excType(), "Commit has no field agentId");
        }
        return agentId;
    }
    ...
    const std::string& getSourceId() const {
        if (!sourceIdFlag) {
            throw Exception( excType(), "Commit has no field sourceId");
        }
        return sourceId;
    }
    ...
    const std::string& getUserId() const {
        if (!userIdFlag) {
            throw Exception( excType(), "Commit has no field userId");
        }
        return userId;
    }
    ...
    const std::string& getWalletType() const {
        if (!walletTypeFlag) {
            throw Exception( excType(), "Commit has no field walletType");
        }
        return walletType;
    }
    ...
    const std::string& getExternalId() const {
        if (!externalIdFlag) {
            throw Exception( excType(), "Commit has no field externalId");
        }
        return externalId;
    }
    ...
    int32_t getTransId() const {
        if (!transIdFlag) {
            throw Exception( excType(), "Commit has no field transId");
        }
        return transId;
    }
    ...
    int32_t getAmount() const {
        if (!amountFlag) {
            throw Exception( excType(), "Commit has no field amount");
        }
        return amount;
    }
        ...
        void serialize( const Protocol& proto, DataStream& writer ) const
    {
        ...
        try {
            ...
            throw Exception( excType(),
                             "writing field agentId in Commit: %s",
                             e.what() );
        }
        try {
            // printf( "write pos=%d field=%d\n", ds.getPos(), userIdTag );
            ...
            throw Exception( excType(),
                             "writing field userId in Commit: %s",
                             e.what() );
        }
        try {
            ...
            throw Exception( excType(),
                             "writing field walletType in Commit: %s",
                             e.what() );
        }
        try {
            // printf( "write pos=%d field=%d\n", ds.getPos(), amountTag );
            ...
            throw Exception( excType(),
                             "writing field amount in Commit: %s",
                             e.what() );
        }
        // optional fields
        if ( sourceIdFlag ) {
            ...
            try {
                ...
                throw Exception( excType(),
                                 "writing field sourceId in Commit: %s",
                                 e.what() );
            }
        }
        if ( externalIdFlag ) {
            ...
            try {
                ...
                throw Exception( excType(),
                                 "writing field externalId in Commit: %s",
                                 e.what() );
            }
        }
        if ( transIdFlag ) {
            ...
            try {
                ...
                throw Exception( excType(),
                                 "writing field transId in Commit: %s",
                                 e.what() );
            }
        }
    }
        ...
        try {
            do {
                ...
                case agentIdTag: {
                    if (agentIdFlag) {
                        throw Exception( excType(),
                                         "duplicate field agentId of Commit" );
                    }
                ...
                case sourceIdTag: {
                    if (sourceIdFlag) {
                        throw Exception( excType(),
                                         "duplicate field sourceId of Commit" );
                    }
                ...
                case userIdTag: {
                    if (userIdFlag) {
                        throw Exception( excType(),
                                         "duplicate field userId of Commit" );
                    }
                ...
                case walletTypeTag: {
                    if (walletTypeFlag) {
                        throw Exception( excType(),
                                         "duplicate field walletType of Commit" );
                    }
                ...
                case externalIdTag: {
                    if (externalIdFlag) {
                        throw Exception( excType(),
                                         "duplicate field externalId of Commit" );
                    }
                ...
                case transIdTag: {
                    if (transIdFlag) {
                        throw Exception( excType(),
                                         "duplicate field transId of Commit" );
                    }
                ...
                case amountTag: {
                    if (amountFlag) {
                        throw Exception( excType(),
                                         "duplicate field amount of Commit" );
                    }
                ...
                default:
                    throw Exception( excType(),
                                     "Commit has invalid field:%u", tag );
                }
            } while ( true );
        } catch ( exceptions::IOException e ) {
            throw Exception( excType(),
...
protected:
    void checkFields() const
    {
        if ( !agentIdFlag ) {
            throw Exception( excType(),
                             "message Commit does not have required field agentId" );
        }
        if ( !userIdFlag ) {
            throw Exception( excType(),
                             "message Commit does not have required field userId" );
        }
        if ( !walletTypeFlag ) {
            throw Exception( excType(),
                             "message Commit does not have required field walletType" );
        }
        if ( !amountFlag ) {
            throw Exception( excType(),
                             "message Commit does not have required field amount" );
        }
