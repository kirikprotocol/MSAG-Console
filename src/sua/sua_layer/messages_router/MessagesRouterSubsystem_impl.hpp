                                                              ...
                                                              const std::string& valueToCompare)
{
  ...
  runtime_cfg::CompositeParameter& parent_parameter = runtimeConfig.find<runtime_cfg::CompositeParameter>(parentParamName);
  ...
  runtime_cfg::CompositeParameter::Iterator<LOOKED_FOR_PARAMETER_TYPE> iterator = parent_parameter.getIterator<LOOKED_FOR_PARAMETER_TYPE>(interestedParamName);
